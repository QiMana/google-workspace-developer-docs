...
This page includes information about the transfer parameters available for applications that support data transfer. This list might not be up to date, and you can dynamically fetch the list of parameters by calling [`Applications.list`](https://developers.google.com/workspace/admin/data-transfer/v1/reference/applications/list).
