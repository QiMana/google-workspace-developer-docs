---
source: https://developers.google.com/workspace/admin/data-transfer/v1/libraries
root: workspace
fetched_at: 2026-04-23T15:23:32.936Z
---

# Client libraries

The Data Transfer API is built on HTTP and JSON, so any standard HTTP client can send requests to it and parse the responses.
...
Get the latest [Data Transfer API client library for Go](https://github.com/google/google-api-go-client). Read the client library's [developer's guide](https://github.com/google/google-api-go-client).
...
<iframe src="https://developers.google.com/frame/workspace/admin/data-transfer/v1/libraries_bf46dd5d3782c17cd7225fed94ece9962880a2acb2a35afebdbe91273ea87cc4.frame" allow="clipboard-write https://developers-dot-devsite-v2-prod.appspot.com" allowfullscreen=""></iframe>
...
<iframe src="https://developers.google.com/frame/workspace/admin/data-transfer/v1/libraries_32d1b2f0c21652b9dd3ec96db31fd9d2b3053f387b2c0986fc5a8d08750a039a.frame" allow="clipboard-write https://developers-dot-devsite-v2-prod.appspot.com" allowfullscreen=""></iframe>
...
Get the latest [Data Transfer API client library for Node.js](https://github.com/google/google-api-nodejs-client/). Read the client library's [developer's guide](https://github.com/google/google-api-nodejs-client/).

### Obj-C

Get the latest [Data Transfer API client library for Objective-C](https://github.com/google/google-api-objectivec-client-for-rest). Read the client library's [developer's guide](https://github.com/google/google-api-objectivec-client-for-rest/wiki).

### PHP

Get the latest [Data Transfer API client library for PHP](https://github.com/google/google-api-php-client). Read the client library's [developer's guide](https://developers.google.com/api-client-library/php).
...
- Browse the [PyDoc reference for the Admin SDK API](https://googleapis.github.io/google-api-python-client/docs/dyn/admin_datatransfer_v1.html).
