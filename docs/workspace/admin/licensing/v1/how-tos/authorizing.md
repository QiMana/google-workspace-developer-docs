---
source: https://developers.google.com/workspace/admin/licensing/v1/how-tos/authorizing
root: workspace
fetched_at: 2026-04-23T15:23:58.762Z
---

# Choose Enterprise License Manager API scopes

This document contains Enterprise License Manager API-specific authorization and authentication information. Before reading this document, be sure to read the Google Workspace's general authentication and authorization information at [Learn about authentication and authorization](../../../../guides/auth-overview.md).
...
## Enterprise License Manager API scopes
...
The Enterprise License Manager API supports the following scopes:

| Scope | Meaning |
| --- | --- |
| `https://www.googleapis.com/auth/apps.licensing` | Read/write access to Enterprise License Manager API. |
