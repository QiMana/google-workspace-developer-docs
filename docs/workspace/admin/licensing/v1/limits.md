...
If your requests must be completed in a fixed period of time, send your requests [batched together](https://developers.google.com/workspace/admin/licensing/v1/how-tos/batch). Depending upon your API's purpose and if the number of requests gets too high, quota errors occur.
