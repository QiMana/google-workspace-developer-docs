...
Projection values indicate what data is included in the representation of a contact. For a list of values, see [Projection values](./overview.md#Projections).
...
- `PROJECTION`: The projection value that specifies the `gd:extendedProperty` elements. For a list of supported values, see [Projection values](./extended-properties-projections.md#projection_values).
