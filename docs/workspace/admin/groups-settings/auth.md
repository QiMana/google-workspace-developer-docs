---
source: https://developers.google.com/workspace/admin/groups-settings/auth
root: workspace
fetched_at: 2026-04-23T15:23:55.805Z
---

# Choose Groups Settings API scopes

This document contains Groups Settings API-specific authorization and authentication information. Before reading this document, be sure to read the Google Workspace's general authentication and authorization information at [Learn about authentication and authorization](../../guides/auth-overview.md).
...
The Groups Settings API supports the following scopes:

| Scopes | Meaning |
| --- | --- |
| `https://www.googleapis.com/auth/apps.groups.settings` | View and manage the settings of Google Groups |
