...
| Renaming users | Can take up to 10 minutes to propagate across all services. Before renaming a user, it is recommended to log out the user from all browser sessions and services. For more details, see [Update users](./guides/manage-users.md#update_user). |
