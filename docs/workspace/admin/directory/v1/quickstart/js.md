...
root: workspace
fetched_at: 2026-04-23T15:23:52.755Z
---

# JavaScript quickstart

Create a JavaScript web application that makes requests to the Directory API.
...
Your JavaScript application runs and calls the Directory API.
