---
source: https://developers.google.com/workspace/admin/directory/v1/quickstart/go
root: workspace
fetched_at: 2026-04-23T15:23:53.014Z
---

# Go quickstart

Create a Go command-line application that makes requests to the Directory API.
