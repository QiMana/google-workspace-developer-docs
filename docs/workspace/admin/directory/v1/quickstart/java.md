---
source: https://developers.google.com/workspace/admin/directory/v1/quickstart/java
root: workspace
fetched_at: 2026-04-23T15:23:52.084Z
---

# Java quickstart

Create a Java command-line application that makes requests to the Directory API.
...
2. The first time you run the sample, it prompts you to authorize access:
	1. If you're not already signed in to your Google Account, sign in when prompted. If you're signed in to multiple accounts, select one account to use for authorization.
		2. Click **Accept**.
	Your Java application runs and calls the Directory API.
...
- [Troubleshoot authentication and authorization issues](https://developers.google.com/workspace/admin/directory/v1/guides/troubleshoot-authentication-authorization)
- [Directory API developer guides](https://developers.google.com/workspace/admin/directory/v1/guides)
- [Directory API reference documentation](https://developers.google.com/workspace/admin/directory/v1/reference)
- [Google APIs Client for Java documentation](https://developers.google.com/api-client-library/java)
- [Directory API Javadoc documentation](https://googleapis.dev/java/google-api-services-admin/latest/index.html)
