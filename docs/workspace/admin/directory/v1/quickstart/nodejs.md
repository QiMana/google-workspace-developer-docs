---
source: https://developers.google.com/workspace/admin/directory/v1/quickstart/nodejs
root: workspace
fetched_at: 2026-04-23T15:23:51.721Z
---

# Node.js quickstart

Create a Node.js command-line application that makes requests to the Directory API.
