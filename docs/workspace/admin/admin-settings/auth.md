---
source: https://developers.google.com/workspace/admin/admin-settings/auth
root: workspace
fetched_at: 2026-04-23T15:23:20.596Z
---

# Choose Admin Settings API scopes

This document contains Admin Settings API-specific authorization and authentication information. Before reading this document, be sure to read the Google Workspace's general authentication and authorization information at [Learn about authentication and authorization](../../guides/auth-overview.md).
...
The Admin Settings API supports the following scopes:

| Scopes | Meaning |
| --- | --- |
| `https://apps-apis.google.com/a/feeds/domain/` | Global scope for access to all domain settings |
