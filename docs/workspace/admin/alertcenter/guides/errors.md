...
This page describes the error codes the Alert Center API returns, explains how to interpret them, and provides guidance on how to resolve them. [Learn more](../../support.md).
...
| **404** | The specified resource was not found. This occurs when the requested alert doesn't exist. | Verify the alert exists (for example, by using the [`alerts.list`](../reference/rest/v1beta1/alerts/list.md) method) and the ID is correct. |
