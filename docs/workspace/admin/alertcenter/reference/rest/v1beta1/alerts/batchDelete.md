---
source: https://developers.google.com/workspace/admin/alertcenter/reference/rest/v1beta1/alerts/batchDelete
root: workspace
fetched_at: 2026-04-23T15:23:27.130Z
---

# Method: alerts.batchDelete

Performs batch delete operation on alerts.

### HTTP request

`POST https://alertcenter.googleapis.com/v1beta1/alerts:batchDelete`
