---
source: https://developers.google.com/workspace/admin/reports/v1/appendix/usage/customer/drive
root: workspace
fetched_at: 2026-04-23T15:24:34.115Z
---
...
| --- | --- | --- |
| `num_1day_active_users` | integer | The number of domain users who performed an activity related to content within Google Drive on a given report day. |
| `num_1day_google_documents_active_users` | integer | The number of domain users who performed an activity on Google Docs on this report date. |
| `num_1day_google_drawings_active_users` | integer | The number of domain users who performed an activity on Google Drawings on this report date. |
| `num_1day_google_forms_active_users` | integer | The number of domain users who performed an activity on Google Forms on this report date. |
| `num_1day_google_presentations_active_users` | integer | The number of domain users who performed an activity on Google Presentations on this report date. |
| `num_1day_google_sites_active_users` | integer | The number of domain users who performed an activity on Google Sites on this report date. |
| `num_1day_google_spreadsheets_active_users` | integer | The number of domain users who performed an activity on Google Spreadsheets on this report date. |
| `num_1day_google_videos_active_users` | integer | The number of domain users who performed an activity on Google Videos on this report date. |
| `num_1day_other_types_active_users` | integer | The number of domain users who performed an activity on any other Google Drive product on this report date. |
| `num_30day_active_users` | integer | The number of domain users who performed an activity related to content within Google Drive in the past 30 days. |
| `num_30day_google_documents_active_users` | integer | The number of domain users who performed an activity on Google Documents at least once in the past 30 days. |
| `num_30day_google_drawings_active_users` | integer | The number of domain users who performed an activity on Google Drawings at least once in the past 30 days. |
| `num_30day_google_forms_active_users` | integer | The number of domain users who performed an activity on Google Forms at least once in the past 30 days. |
| `num_30day_google_presentations_active_users` | integer | The number of domain users who performed an activity on Google Presentations at least once in the past 30 days. |
| `num_30day_google_sites_active_users` | integer | The number of domain users who performed an activity on Google Sites at least once in the past 30 days. |
| `num_30day_google_spreadsheets_active_users` | integer | The number of domain users who performed an activity on Google Spreadshets at least once in the past 30 days. |
| `num_30day_google_videos_active_users` | integer | The number of domain users who performed an activity on Google Videos at least once in the past 30 days. |
| `num_30day_other_types_active_users` | integer | The number of domain users who performed an activity on any other Google Drive product at least once in the past 30 days. |
| `num_7day_active_users` | integer | The number of domain users who performed an activity related to content within Google Drive in the past 7 days. |
| `num_7day_google_documents_active_users` | integer | The number of domain users who performed an activity on Google Documents at least once in the past 7 days. |
| `num_7day_google_drawings_active_users` | integer | The number of domain users who performed an activity on Google Drawings at least once in the past 7 days. |
| `num_7day_google_forms_active_users` | integer | The number of domain users who performed an activity on Google Forms at least once in the past 7 days. |
| `num_7day_google_presentations_active_users` | integer | The number of domain users who performed an activity on Google Presentations at least once in the past 7 days. |
| `num_7day_google_sites_active_users` | integer | The number of domain users who performed an activity on Google Sites at least once in the past 7 days. |
| `num_7day_google_spreadsheets_active_users` | integer | The number of domain users who performed an activity on Google Spreadsheets at least once in the past 7 days. |
| `num_7day_google_videos_active_users` | integer | The number of domain users who performed an activity on Google Videos at least once in the past 7 days. |
| `num_7day_other_types_active_users` | integer | The number of domain users who performed an activity on any other Google Drive product at least once in the past 7 days. |
| `num_collaborators` | integer | The number of domain users editing and commenting/suggesting/marking to-dos on files, but only on files they do not own. |
| `num_consumers` | integer | The number of domain users viewing files. This doesn't include printing or previewing. |
| `num_creators` | integer | The number of domain users who create files. Includes uploading content but not other addition type events, like untrashing, undeleting, or ownership transfer. |
...
| `num_monthly_active_users` | integer | The number of monthly active users. |
...
| `num_sharers` | integer | The number of users with non-private visibility of a Google Drive item. |
