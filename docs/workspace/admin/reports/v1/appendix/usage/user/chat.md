...
This document lists the parameters for various types of Google Chat activity events. You can retrieve these events by calling [UserUsageReport.get()](../../../../reference/rest/v1/userUsageReport/get.md) with `parameters=chat:PARAMETER`.
