...
This document lists the events and parameters for various types of User Accounts Audit activity events. You can retrieve these events by calling [Activities.list()](../../../reference/rest/v1/activities/list.md) with `applicationName=user_accounts`.
