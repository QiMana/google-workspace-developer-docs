...
This document lists the events and parameters for various types of Admin Data Action Audit activity events. You can retrieve these events by calling [Activities.list()](https://developers.google.com/workspace/admin/reports/v1/reference/activities/list) with `applicationName=admin_data_action`.
