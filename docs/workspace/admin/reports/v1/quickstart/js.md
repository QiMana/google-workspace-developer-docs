---
source: https://developers.google.com/workspace/admin/reports/v1/quickstart/js
root: workspace
fetched_at: 2026-04-23T15:24:38.597Z
---

# JavaScript quickstart

Create a JavaScript web application that makes requests to the Admin SDK API.
	...
	<  /h>ead
	 ...
	 ><   p>re id=<"content" style=&qu>ot;white-space: pre-wrap;"/pre
	  ...
	  <            const time = activity.id.time;
	              const email = activity.><actor.e>mail;<
	              const eventName = activity.events[0].name;
	              return \`${st><r}-${ti>me}<: ${e>m<ail} >(${eventName})\n\`;
	            },
	            'Logins:\n');
...
Your JavaScript application runs and calls the Admin SDK API.
