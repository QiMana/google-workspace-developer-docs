...
An [artifact](./overview.md#artifact) is a file or data generated by Google Meet in response to a [conference](./overview.md#conference). This includes video recordings and other artifacts, such as transcripts.

To produce artifacts, participants must configure them in Meet before the conference ends. For more information, see [Manage auto artifacts](./meeting-spaces-configuration.md#auto-artifacts).
...
The [`recordings`](../reference/rest/v2/conferenceRecords.recordings.md) resource includes both the [`DriveDestination`](../reference/rest/v2/conferenceRecords.recordings.md#drivedestination) and the [`State`](../reference/rest/v2/conferenceRecords.recordings.md#state) objects.

The `DriveDestination` object holds the export location in Drive where the recording is saved as an MP4 file. To download the recording or to play it back in a browser, use the object's [`exportUri`](../reference/rest/v2/conferenceRecords.recordings.md#DriveDestination.FIELDS.export_uri) field value. If you're familiar with the Google Drive API, the [`file`](../reference/rest/v2/conferenceRecords.recordings.md#DriveDestination.FIELDS.file) field value corresponds to the [`id`](../../../drive/api/reference/rest/v3/files.md#File.FIELDS.id) field in the [`files`](../../../drive/api/reference/rest/v3/files.md) resource. For more information, see [Download and export files](../../../drive/api/guides/manage-downloads.md).
...
To get details about a specific recording, use the [`get`](../reference/rest/v2/conferenceRecords.recordings/get.md) method on the [`recordings`](../reference/rest/v2/conferenceRecords.recordings.md) resource. Set the `name` path parameter using the format `conferenceRecords/{conferenceRecord}/recordings/{recordingName}`.
...
To list details about all recordings in a conference record, use the [`list`](../reference/rest/v2/conferenceRecords.recordings/list.md) method on the [`recordings`](../reference/rest/v2/conferenceRecords.recordings.md) resource. Set the `parent` path parameter using the format `conferenceRecords/{conferenceRecord}`.
...
The [`transcripts`](../reference/rest/v2/conferenceRecords.transcripts.md) resource includes both the [`DocsDestination`](../reference/rest/v2/conferenceRecords.transcripts.md#docsdestination) and the [`State`](../reference/rest/v2/conferenceRecords.transcripts.md#state) objects.

The `DocsDestination` object holds the export location in Drive where the Google Docs transcript file is saved. To fetch the content or to browse the transcript in a browser, use the object's [`exportUri`](../reference/rest/v2/conferenceRecords.transcripts.md#DocsDestination.FIELDS.export_uri) field value. If you're familiar with the Google Docs API, the [`document`](../reference/rest/v2/conferenceRecords.transcripts.md#DocsDestination.FIELDS.document) field value corresponds to the [`documentId`](../../../docs/api/reference/rest/v1/documents.md#Document.FIELDS.document_id) in the [`documents`](../../../docs/api/reference/rest/v1/documents.md) resource.
...
To get details about a specific transcript, use the [`get`](../reference/rest/v2/conferenceRecords.transcripts/get.md) method on the [`transcripts`](../reference/rest/v2/conferenceRecords.transcripts.md) resource. Set the `name` path parameter using the format `conferenceRecords/{conferenceRecord}/transcripts/{transcriptName}`.
...
To list details about all transcripts in a conference record, use the [`list`](../reference/rest/v2/conferenceRecords.transcripts/list.md) method on the [`transcripts`](../reference/rest/v2/conferenceRecords.transcripts.md) resource. Set the `parent` path parameter using the format `conferenceRecords/{conferenceRecord}`.
...
Each transcript entry is connected to a `participant` name in the conference. To retrieve participant details, see [Get details about a participant](./participants.md#get-participant).
...
To get details about a specific transcript entry, use the [`get`](../reference/rest/v2/conferenceRecords.transcripts.entries/get.md) method on the [`transcripts.entries`](../reference/rest/v2/conferenceRecords.transcripts.entries.md) resource. Set the `name` path parameter using the format `conferenceRecords/{conferenceRecord}/transcripts/{transcriptName}/entries/{transcriptEntryName}`.
...
To list details about all transcript entries in a transcript, use the [`list`](../reference/rest/v2/conferenceRecords.transcripts.entries/list.md) method on the [`transcripts.entries`](../reference/rest/v2/conferenceRecords.transcripts.entries.md) resource. Set the `parent` path parameter using the format `conferenceRecords/{conferenceRecord}/transcripts/{transcript}`.
...
The [`smartNotes`](../reference/rest/v2/conferenceRecords.smartNotes.md) resource includes the [`State`](../reference/rest/v2/conferenceRecords.smartNotes.md#state) object. This object holds the status of the smart notes session. This lets you query if the smart notes session has started, if the smart notes session has ended but the smart notes file isn't ready, or if the smart notes file is generated and ready to download.

The `smartNotes` resource also includes the [`DocsDestination`](../reference/rest/v2/DocsDestination.md) object type. This object holds the export location in Drive where the Google Docs smart notes file is saved. To fetch the content or to browse the smart notes in a browser, use the object's [`exportUri`](../reference/rest/v2/DocsDestination.md#FIELDS.export_uri) field value. If you're familiar with the Google Docs API, the [`document`](../reference/rest/v2/DocsDestination.md#FIELDS.document) field value corresponds to the [`documentId`](../../../docs/api/reference/rest/v1/documents.md#Document.FIELDS.document_id) in the [`documents`](../../../docs/api/reference/rest/v1/documents.md) resource.

You can manage smart notes using the [`get`](#get-smart-notes) and [`list`](#list-smart-notes) methods.

### Get details about smart notes

To get details about a specific smart notes file, use the [`get`](../reference/rest/v2/conferenceRecords.smartNotes/get.md) method on the `smartNotes` resource. Set the `name` path parameter using the format `conferenceRecords/{conferenceRecord}/smartNotes/{smartNote}`.
...
To list details about all smart notes files in a conference record, use the [`list`](../reference/rest/v2/conferenceRecords.smartNotes/list.md) method on the `smartNotes` resource. Set the `parent` path parameter using the format `conferenceRecords/{conferenceRecord}`.
