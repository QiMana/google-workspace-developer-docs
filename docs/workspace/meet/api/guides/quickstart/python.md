---
source: https://developers.google.com/workspace/meet/api/guides/quickstart/python
root: workspace
fetched_at: 2026-04-23T15:30:28.849Z
---

# Python quickstart

Create a Python command-line application that makes requests to the Google Meet API.
...
- Install the Google client library for Python:
	```
	python3 -m pip install --upgrade google-apps-meet google-auth-httplib2 google-auth-oauthlib
	```
...
2. The first time you run the sample, it prompts you to authorize access:
	1. If you're not already signed in to your Google Account, sign in when prompted. If you're signed in to multiple accounts, select one account to use for authorization.
		2. Click **Accept**.
	Your Python application runs and calls the Google Meet API.
...
- [Client library documentation](https://googleapis.dev/python/google-apps-meet/latest/)
