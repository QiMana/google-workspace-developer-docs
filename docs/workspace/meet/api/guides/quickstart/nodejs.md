---
source: https://developers.google.com/workspace/meet/api/guides/quickstart/nodejs
root: workspace
fetched_at: 2026-04-23T15:30:28.944Z
---

# Node.js quickstart

Create a Node.js command-line application that makes requests to the Google Meet API.
