---
source: https://developers.google.com/workspace/meet/media-api/reference/dc/media_api.mediaapiresponse
root: workspace
fetched_at: 2026-04-23T15:30:45.578Z
---
...
```
declare interface MediaApiResponse
```
