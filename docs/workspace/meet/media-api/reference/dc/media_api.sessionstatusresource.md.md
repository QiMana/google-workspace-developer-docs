---
source: https://developers.google.com/workspace/meet/media-api/reference/dc/media_api.sessionstatusresource.md
root: workspace
fetched_at: 2026-04-23T15:30:53.738Z
---

# Interface SessionStatusResource
...
```
declare interface SessionStatusResource extends ResourceSnapshot
```
