---
source: https://developers.google.com/workspace/meet/media-api/reference/dc/media_api.mediastatsresource
root: workspace
fetched_at: 2026-04-23T15:30:50.105Z
---

# Interface MediaStatsResource
...
```
declare interface MediaStatsResource extends ResourceSnapshot
```
