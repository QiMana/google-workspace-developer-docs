...
root: workspace
fetched_at: 2026-04-23T15:24:55.218Z
---

# Freebusy: query

Returns free/busy information for a set of calendars. [Try it now](#try-it).
...
Scope`https://www.googleapis.com/auth/calendar.readonly``https://www.googleapis.com/auth/calendar``https://www.googleapis.com/auth/calendar.events.freebusy``https://www.googleapis.com/auth/calendar.freebusy`
