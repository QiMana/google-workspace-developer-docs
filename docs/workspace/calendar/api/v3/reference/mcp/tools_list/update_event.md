...
root: workspace
fetched_at: 2026-04-23T15:24:57.032Z
---
...
- Add [john.doe@google.com](mailto:john.doe@google.com) to the meeting tomorrow.
...
<table><colgroup><col width="25%"> <col></colgroup><thead><tr><th colspan="2">Fields</th></tr></thead><tbody><tr><td><code>eventId</code></td><td><p><code>string</code></p><p>Required. The ID of the event to update.</p></td></tr><tr><td><code>addedAttendeeEmails[]</code></td><td><p><code>string</code></p><p>Optional. The additional attendees of the event, as email addresses.</p></td></tr><tr><td><code>removedAttendeeEmails[]</code></td><td><p><code>string</code></p><p>Optional. The attendees of the event to remove, as email addresses.</p></td></tr><tr><td colspan="2"><p>Union field <code>_calendar_id</code>.</p><p><code>_calendar_id</code> can be only one of the following:</p></td></tr><tr><td><code>calendarId</code></td><td><p><code>string</code></p><p>Optional. The calendar ID of the event to update. The default is the user's primary calendar.</p></td></tr><tr><td colspan="2"><p>Union field <code>_summary</code>.</p><p><code>_summary</code> can be only one of the following:</p></td></tr><tr><td><code>summary</code></td><td><p><code>string</code></p><p>Optional. The new title of the event. Will not be updated if not set.</p></td></tr><tr><td colspan="2"><p>Union field <code>_description</code>.</p><p><code>_description</code> can be only one of the following:</p></td></tr><tr><td><code>description</code></td><td><p><code>string</code></p><p>Optional. The new description of the event. Will not be updated if not set.</p></td></tr><tr><td colspan="2"><p>Union field <code>_location</code>.</p><p><code>_location</code> can be only one of the following:</p></td></tr><tr><td><code>location</code></td><td><p><code>string</code></p><p>Optional. The new location of the event. Will not be updated if not set.</p></td></tr><tr><td colspan="2"><p>Union field <code>_start_time</code>.</p><p><code>_start_time</code> can be only one of the following:</p></td></tr><tr><td><code>startTime</code></td><td><p><code>string</code></p><p>Optional. The new start time of the event formatted as per ISO 8601. Will not be updated if not set.</p></td></tr><tr><td colspan="2"><p>Union field <code>_end_time</code>.</p><p><code>_end_time</code> can be only one of the following:</p></td></tr><tr><td><code>endTime</code></td><td><p><code>string</code></p><p>Optional. The new end time of the event formatted as per ISO 8601. Will not be updated if not set.</p></td></tr><tr><td colspan="2"><p>Union field <code>_notification_level</code>.</p><p><code>_notification_level</code> can be only one of the following:</p></td></tr><tr><td><code>notificationLevel</code></td><td><p><code>enum (<code>NotificationLevel</code>)</code></p><p>Optional. Which email notification should be sent for this event update. Possible values are:</p><ul><li><code>NONE</code> - No email notifications are sent (default).</li><li><code>EXTERNAL_ONLY</code> - Only external (non-Calendar) attendees receive email notifications.</li><li><code>ALL</code> - All event attendees receive email notifications.</li></ul></td></tr><tr><td colspan="2"><p>Union field <code>_add_google_meet_url</code>.</p><p><code>_add_google_meet_url</code> can be only one of the following:</p></td></tr><tr><td><code>addGoogleMeetUrl</code></td><td><p><code>boolean</code></p><p>Optional. Allows to create or update a Google Meet url for the event. By default, no Google Meet url is created or updated. No Google Meet url is created or updated if Meet is disabled for the user, but the event update will succeed.</p></td></tr><tr><td colspan="2"><p>Union field <code>_visibility</code>.</p><p><code>_visibility</code> can be only one of the following:</p></td></tr><tr><td><code>visibility</code></td><td><p><code>string</code></p><p>Optional. New visibility of the event. Possible values are:</p><ul><li><code>default</code> - Uses the default visibility for events on the calendar. This is the default value.</li><li><code>public</code> - The event is public and event details are visible to all readers of the calendar.</li><li><code>private</code> - The event is private and only event attendees may view event details.</li></ul></td></tr><tr><td colspan="2"><p>Union field <code>_color_id</code>.</p><p><code>_color_id</code> can be only one of the following:</p></td></tr><tr><td><code>colorId</code></td><td><p><code>string</code></p><p>Optional. New color ID of the event. Will not be updated if not set. Event color ID (string <code>1</code> - <code>11</code>):</p><ul><li>1: Lavender</li><li>2: Sage</li><li>3: Grape</li><li>4: Flamingo</li><li>5: Banana</li><li>6: Tangerine</li><li>7: Peacock</li><li>8: Graphite</li><li>9: Blueberry</li><li>10: Basil</li><li>11: Tomato.</li></ul></td></tr></tbody></table>
