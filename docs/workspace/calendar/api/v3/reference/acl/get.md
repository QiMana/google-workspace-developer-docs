...
root: workspace
fetched_at: 2026-04-23T15:24:51.976Z
---

# Acl: get

Returns an access control rule. [Try it now](#try-it).
...
Scope`https://www.googleapis.com/auth/calendar.readonly``https://www.googleapis.com/auth/calendar``https://www.googleapis.com/auth/calendar.acls``https://www.googleapis.com/auth/calendar.acls.readonly`
