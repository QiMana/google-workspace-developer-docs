...
root: workspace
fetched_at: 2026-04-23T15:24:52.984Z
---

# CalendarList: insert

Inserts an existing calendar into the user's calendar list. [Try it now](#try-it).
