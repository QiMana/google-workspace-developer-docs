---
source: https://developers.google.com/workspace/calendar/api/downloads
root: workspace
fetched_at: 2026-04-23T15:24:48.151Z
---
...
| --- | --- |
| [Google API Client Library for Java](https://developers.google.com/api-client-library/java/) | [Java samples](https://developers.google.com/api-client-library/java/apis/calendar/v3) |
...
| [Google API Client Library for.NET](https://developers.google.com/api-client-library/dotnet/get_started) | [.NET samples](https://developers.google.com/api-client-library/dotnet/apis/calendar/v3) |
...
This guide provides specific setup instructions for some of these libraries. If you're working in Java, Python, PHP,.NET or Ruby, refer to [Set up a Client Library](https://developers.google.com/workspace/calendar/setup)
