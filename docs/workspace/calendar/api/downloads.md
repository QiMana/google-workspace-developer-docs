...
This guide provides specific setup instructions for some of these libraries. If you're working in Java, Python, PHP,.NET or Ruby, refer to [Set up a Client Library](../../calendar.md)
