---
source: https://developers.google.com/workspace/classroom/quickstart/go
root: workspace
fetched_at: 2026-04-23T15:25:50.356Z
---

# Go quickstart

Create a Go command-line application that makes requests to the Google Classroom API.
