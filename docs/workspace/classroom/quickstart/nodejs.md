---
source: https://developers.google.com/workspace/classroom/quickstart/nodejs
root: workspace
fetched_at: 2026-04-23T15:25:51.121Z
---

# Node.js quickstart

Create a Node.js command-line application that makes requests to the Google Classroom API.
