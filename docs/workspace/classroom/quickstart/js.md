---
source: https://developers.google.com/workspace/classroom/quickstart/js
root: workspace
fetched_at: 2026-04-23T15:25:50.607Z
---

# JavaScript quickstart

Create a JavaScript web application that makes requests to the Google Classroom API.
...
Your JavaScript application runs and calls the Google Classroom API.
