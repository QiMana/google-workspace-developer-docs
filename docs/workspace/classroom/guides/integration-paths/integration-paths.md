...
This guide introduces the options to connect your service or application with Google Classroom. Select one of these paths to make your content available to users within Classroom [stream items](../key-concepts/api-structure.md#stream_items).

## Integration options

There are three ways to connect your learning materials to Google Classroom:

1. Embed [Classroom Share](../sharebutton.md) buttons in your product
2. Use [`CourseWork` API](../coursework-integration.md) to create and manage stream items with hyperlinks to your product
3. Build a [Classroom add-on](../../add-ons.md) to to let users discover and access your content within Google Classroom
