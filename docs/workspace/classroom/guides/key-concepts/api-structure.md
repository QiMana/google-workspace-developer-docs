...
| --- | --- |
| [Courses](https://developers.google.com/workspace/classroom/reference/rest/v1/courses) | A class, like "M. Smith's 4th period math". |
| [Aliases](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.aliases) | An alternative ID for a course. |
| [Invitations](https://developers.google.com/workspace/classroom/reference/rest/v1/invitations) | A means to add users to a class. |
| [Students](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.students) | A student in a class. |
| [Teachers](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.teachers) | A teacher in a class. |
| [User profiles](https://developers.google.com/workspace/classroom/reference/rest/v1/userProfiles) | A user more generically, outside the context of student or teacher. |
| [CourseWork](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.courseWork) | An assignment in a class. |
| [StudentSubmissions](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.courseWork.studentSubmissions) | A students work for a given assignment, like answers or worksheets. |
| [CourseWorkMaterials](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.courseWorkMaterials) | Materials for students in a class. |
| [Announcements](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.announcements) | An announcement to students in a class. |
| [AddOnAttachment](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.courseWork.addOnAttachments) | Content or an activity on an assignment or material that is typically displayed as an embedded iframe. |
| [Topics](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.topics) | A visual grouping of assignments and materials in a class. |
| [Registrations](https://developers.google.com/workspace/classroom/reference/rest/v1/registrations) | An instruction to send notifications to your app for changes in data, like a class roster. |
...
For detailed information on the API resources and methods, refer to the [Classroom API reference](https://developers.google.com/workspace/classroom/reference/rest).
...
Google Classroom is available to **domains** that subscribe to Google Workspace for Education. A [domain](https://support.google.com/a/answer/177483) in the Classroom context typically represents a school district. You can create a Google Workspace for Education [test domain](https://developers.google.com/workspace/classroom/support/access) for the purposes of development, which gives you control of a production instance of Classroom without affecting real users.

## Courses and Aliases

`Courses` represent a class, such as "M. Smith's 4th period math", and its assigned teachers, student roster, and metadata. Each course is identified by a unique ID assigned by the server. The `Course` resource specifically encapsulates all of the metadata about the course, such as the name, description, location, and time. Course rosters are managed through the [Student](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.students), [Teacher](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.teachers), and [Invitation](https://developers.google.com/workspace/classroom/reference/rest/v1/invitations) resources and their methods.
...
For more information about managing course metadata and aliases, see [Manage Courses](https://developers.google.com/workspace/classroom/guides/manage-courses).
...
`UserProfiles` represent a mapping to a user's domain profile as identified by the unique ID or email address of the user returned by the [Directory API](https://developers.google.com/admin-sdk/directory/v1/guides/manage-users). The current user may also refer to their own ID using the `"me"` shorthand.
...
For more information on managing rosters, see [Manage Teachers and Students](https://developers.google.com/workspace/classroom/guides/manage-users).
...
For more information about managing coursework and student submissions, see [Manage coursework](https://developers.google.com/workspace/classroom/guides/manage-coursework).
...
An **add-on** is a developer-served UI and backend typically displayed in an iframe. Add-ons appear as attachments on a stream item. The stream item can be any [`Announcements`](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.announcements), [`CourseWork`](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.courseWork), or [`CourseWorkMaterials`](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.courseWorkMaterials). Add-on attachments are represented by an `AddOnAttachment`.
...
See the [add-ons development guides](https://developers.google.com/workspace/classroom/add-ons) for more information.
...
See the [push notifications guide](https://developers.google.com/workspace/classroom/best-practices/push-notifications) to learn more.
