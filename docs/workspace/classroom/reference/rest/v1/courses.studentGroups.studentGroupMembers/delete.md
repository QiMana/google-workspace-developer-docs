...
- `PERMISSION_DENIED` if the requesting user is not permitted to delete the requested student group member or for [access errors](../../../../troubleshooting/common-errors.md).
