...
- `PERMISSION_DENIED` if the requesting developer project did not create the corresponding announcement or for [access errors](../../../../troubleshooting/common-errors.md).
