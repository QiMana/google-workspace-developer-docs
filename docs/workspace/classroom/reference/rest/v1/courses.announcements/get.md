...
- `PERMISSION_DENIED` if the requesting user is not permitted to access the requested course or announcement, or for [access errors](../../../../troubleshooting/common-errors.md).
