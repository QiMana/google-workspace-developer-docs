---
source: https://developers.google.com/workspace/classroom/reference/rest/v1/courses.aliases/list
root: workspace
fetched_at: 2026-04-23T15:25:53.751Z
---
...
- `PERMISSION_DENIED` if the requesting user is not permitted to access the course or for [access errors](https://developers.google.com/workspace/classroom/reference/Access.Errors).
...
<table><colgroup><col width="25%"> <col></colgroup><thead><tr><th colspan="2">Parameters</th></tr></thead><tbody><tr><td><code>courseId</code></td><td><p><code>string</code></p><p>The identifier of the course. This identifier can be either the Classroom-assigned identifier or an .</p></td></tr></tbody></table>
