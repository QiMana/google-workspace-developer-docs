---
source: https://developers.google.com/workspace/vault/quickstart/python
root: workspace
fetched_at: 2026-04-23T15:32:03.881Z
---

# Python quickstart

Create a Python command-line application that makes requests to the Google Vault API.
