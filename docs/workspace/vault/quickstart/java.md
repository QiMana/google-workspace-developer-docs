---
source: https://developers.google.com/workspace/vault/quickstart/java
root: workspace
fetched_at: 2026-04-23T15:32:04.166Z
---
...
- In the Google Cloud console, enable the Google Vault API.
	[Enable the API](https://console.cloud.google.com/flows/enableapi?apiid=vault.googleapis.com)
...
- [Troubleshoot authentication and authorization issues](https://developers.google.com/workspace/vault/troubleshoot-authentication-authorization)
- [Vault API reference documentation](https://developers.google.com/workspace/vault/reference/rest)
- [Google APIs Client for Java documentation](https://developers.google.com/api-client-library/java)
- [Google Vault API Javadoc documentation](https://googleapis.dev/java/google-api-services-vault/latest/index.html)
