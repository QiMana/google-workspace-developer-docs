...
This page describes the error codes you might get when using the Google Vault API, how to interpret them, and what to do when you get them. If you need more help with an error, review the [support resources](https://developers.google.com/workspace/vault/support).
...
| 429 | The request exceeds a Vault API quota. | Review the [Vault API usage limits](https://developers.google.com/workspace/vault/limits) and use an exponential backoff algorithm as described on that page. |
