---
source: https://developers.google.com/workspace/slides/api/quickstart/nodejs
root: workspace
fetched_at: 2026-04-23T15:31:50.459Z
---

# Node.js quickstart

Create a Node.js command-line application that makes requests to the Google Slides API.
