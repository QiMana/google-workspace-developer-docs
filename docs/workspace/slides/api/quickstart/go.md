---
source: https://developers.google.com/workspace/slides/api/quickstart/go
root: workspace
fetched_at: 2026-04-23T15:31:49.875Z
---

# Go quickstart

Create a Go command-line application that makes requests to the Google Slides API.
