---
source: https://developers.google.com/workspace/slides/api/quickstart/java
root: workspace
fetched_at: 2026-04-23T15:31:46.264Z
---

# Java quickstart

Create a Java command-line application that makes requests to the Google Slides API.
...
2. The first time you run the sample, it prompts you to authorize access:
	1. If you're not already signed in to your Google Account, sign in when prompted. If you're signed in to multiple accounts, select one account to use for authorization.
		2. Click **Accept**.
	Your Java application runs and calls the Google Slides API.
...
- [Slides API reference documentation](../reference/rest.md)
- [Google APIs Client for Java documentation](https://developers.google.com/api-client-library/java)
- [Google Slides API Javadoc documentation](https://googleapis.dev/java/google-api-services-slides/latest/index.html)
