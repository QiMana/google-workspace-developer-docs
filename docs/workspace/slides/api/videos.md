---
source: https://developers.google.com/workspace/slides/api/videos
root: workspace
fetched_at: 2026-04-23T15:31:56.895Z
---
...
When creating a slide template from which you can generate hundreds of custom decks, learning how to replace text & image placeholders is a key skill.

(Running time: 5:18)

This feature is also described in the blog post ["Introducing the Google Slides API"](https://cloud.google.com/blog/products/application-development/introducing-google-slides-api).
...
This feature is also described in the blog post ["Adding text and shapes with the Google Slides API"](https://developers.googleblog.com/2017/02/adding-text-and-shapes-with-google.html).
...
This feature is also described in the blog post ["Formatting text with the Google Slides API"](https://developers.googleblog.com/2016/12/formatting-text-with-the-google-slides-api.html).
...
This feature is also described in the blog post ["Generating slides from spreadsheet data"](https://developers.googleblog.com/2016/11/generating-slides-from-spreadsheet-data.html).
...
This feature is also described in the blog post ["Generating Google Slides from images"](https://workspace.google.com/blog/developers-practitioners/generating-google-slides-from-images).
...
This feature is also described in the blog post ["Making progress (bars) with Slides add-ons"](https://developers.googleblog.com/en/making-progress-bars-with-slides-add-ons/).
