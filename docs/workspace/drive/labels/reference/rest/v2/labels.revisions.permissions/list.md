---
source: https://developers.google.com/workspace/drive/labels/reference/rest/v2/labels.revisions.permissions/list
root: workspace
fetched_at: 2026-04-23T15:28:11.049Z
---
...
`GET https://drivelabels.googleapis.com/v2/{parent=labels/*/revisions/*}/permissions`

The URL uses [gRPC Transcoding](https://google.aip.dev/127) syntax.

### Path parameters

<table><colgroup><col width="25%"> <col></colgroup><thead><tr><th colspan="2">Parameters</th></tr></thead><tbody><tr><td><code>parent</code></td><td><p><code>string</code></p><p>Required. The parent label resource name on which label permissions are listed. Format: <code>labels/{label}</code>.</p></td></tr></tbody></table>
