---
source: https://developers.google.com/workspace/drive/labels/reference/rest/v2/labels/updatePermissions
root: workspace
fetched_at: 2026-04-23T15:28:12.740Z
---
...
`PATCH https://drivelabels.googleapis.com/v2/{parent=labels/*}/permissions`
