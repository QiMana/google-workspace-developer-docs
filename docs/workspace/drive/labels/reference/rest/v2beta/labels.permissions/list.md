---
source: https://developers.google.com/workspace/drive/labels/reference/rest/v2beta/labels.permissions/list
root: workspace
fetched_at: 2026-04-23T15:28:15.250Z
---
...
`GET https://drivelabels.googleapis.com/v2beta/{parent=labels/*}/permissions`
