---
source: https://developers.google.com/workspace/drive/api/reference/rest/v2/drives/delete
root: workspace
fetched_at: 2026-04-23T15:27:52.664Z
---
...
`DELETE https://www.googleapis.com/drive/v2/drives/{driveId}`
