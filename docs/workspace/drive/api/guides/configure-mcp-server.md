...
root: workspace
fetched_at: 2026-04-23T15:27:34.852Z
---
...
- **Transport**: HTTP
- **Authentication**: The Google Drive remote MCP server uses OAuth 2.0. For details, see [Learn about authentication and authorization](https://developers.google.com/workspace/guides/auth-overview).
