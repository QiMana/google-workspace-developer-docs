...
root: workspace
fetched_at: 2026-04-23T15:27:33.099Z
---
...
The resource name of the label. The *label ID* is part of the Label name. Depending on the request, the name is in the form of either: `labels/{id}` or `labels/{id}@{revisionId}`. For more information, see [Label revision](#revision) below.
