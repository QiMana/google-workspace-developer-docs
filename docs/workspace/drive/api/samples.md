...
For introductory videos about Drive API, see the [Drive API video library](./guides/videos.md).
...
The [Google Picker code sample](../picker/guides/sample.md) shows how to use an image selector or upload page that users can open from a button in a web app.
...
- [Integrate with Drive UI's "New" button](./guides/integrate-create.md)
- [Integrate with Drive UI's "Open with" context menu](./guides/integrate-open.md)

The flow for both use cases is similar. Drive redirects a user to the app after the user selects it from the create menu or the context menu of a file with a registered [MIME type](./guides/mime-types.md).
...
- [The Google Picker API](../picker/guides/overview.md)
- [Drive UI integration overview](./guides/about-apps.md)
