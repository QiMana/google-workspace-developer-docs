---
source: https://developers.google.com/workspace/drive/activity/v2/libraries
root: workspace
fetched_at: 2026-04-23T15:27:15.875Z
---

# Google Drive Activity API: Downloads
...
| --- | --- |
| [Google API Client Library for Java](https://developers.google.com/api-client-library/java/) | [Java samples](https://developers.google.com/api-client-library/java/apis/driveactivity/v2) |
...
| [Google API Client Library for.NET](https://developers.google.com/api-client-library/dotnet/get_started) | [.NET samples](https://developers.google.com/api-client-library/dotnet/apis/driveactivity/v2) |
