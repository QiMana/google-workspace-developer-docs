---
source: https://developers.google.com/workspace/drive/activity/v2/quickstart/go
root: workspace
fetched_at: 2026-04-23T15:27:29.037Z
---

# Go quickstart

Create a Go command-line application that makes requests to the Google Drive Activity API.
...
3. Initialize the new module:
	...
	```
4. Get the Google Drive Activity API Go client library and OAuth2.0 package:
	```
