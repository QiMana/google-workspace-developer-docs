---
source: https://developers.google.com/workspace/sheets/api/videos
root: workspace
fetched_at: 2026-04-23T15:31:41.221Z
---
...
In this introductory video to the Google Sheets API, learn how to migrate SQL data to a Google Sheet. After the video, move on to the [Sheets API codelab](http://g.co/codelabs/sheets) where you can build a customized reporting tool for a fictitious toy company. The database used in that app is the same database used in the video.

(Running time: 7:29)

This feature is also described in the blog post ["Introducing the Google Sheets API v4: Transferring data from a SQL database to a Sheet"](http://cloud.google.com/blog/products/application-development/introducing-google-sheets-api-v4).
...
This feature is also described in the blog post ["Formatting cells with the Google Sheets API"](https://workspace.google.com/blog/developers-practitioners/formatting-cells-with-the-google-sheets-api).
...
This feature is also described in the blog post ["Generating slides from spreadsheet data"](https://developers.googleblog.com/en/generating-slides-from-spreadsheet-data/).
...
This feature is also described in the blog post ["(A day at the office) Automating YouTube stats with Google Apps Script"](https://developers.googleblog.com/en/a-day-at-the-office-automating-youtube-stats-with-google-apps-script/).
