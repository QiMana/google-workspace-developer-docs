...
| public static final [Parser](./Configuration.Parser.md) <Boolean> | [BOOLEAN\_PARSER](./Configuration.md#BOOLEAN_PARSER) | `Configuration.Parser` for parsing string values as boolean. |
| --- | --- | --- |
| public static final [Parser](./Configuration.Parser.md) <Double> | [DOUBLE\_PARSER](./Configuration.md#DOUBLE_PARSER) | `Configuration.Parser` for parsing string values as double. |
| public static final [Parser](./Configuration.Parser.md) <Integer> | [INTEGER\_PARSER](./Configuration.md#INTEGER_PARSER) | `Configuration.Parser` for parsing string values as integer. |
| public static final [Parser](./Configuration.Parser.md) <String> | [STRING\_PARSER](./Configuration.md#STRING_PARSER) | `Configuration.Parser` for parsing string values. |

### Public Method Summary

| static void | [checkConfiguration](./Configuration.md#checkConfiguration(boolean,%20java.lang.String,%20java.lang.Object...)) (boolean condition, String errorFormat, Object... errorArgs)  Checks for a configuration error. |
| --- | --- |
| static void | [checkConfiguration](./Configuration.md#checkConfiguration(boolean,%20java.lang.String)) (boolean condition, String errorMessage)  Checks for a configuration error. |
| static [ConfigValue](./ConfigValue.md) <Boolean> | [getBoolean](./Configuration.md#getBoolean(java.lang.String,%20java.lang.Boolean)) (String configKey, Boolean defaultValue)  Get configuration values parsed as boolean for supplied configuration key. |
| static Properties | [getConfig](./Configuration.md#getConfig()) ()  Retrieves all of the configuration properties. |
| static [ConfigValue](./ConfigValue.md) <Integer> | [getInteger](./Configuration.md#getInteger(java.lang.String,%20java.lang.Integer)) (String configKey, Integer defaultValue)  Get configuration values parsed as integer for supplied configuration key. |
| static <T> [ConfigValue](./ConfigValue.md) <List<T>> | [getMultiValue](./Configuration.md#getMultiValue(java.lang.String,%20java.util.List%3CT%3E,%20com.google.enterprise.cloudsearch.sdk.config.Configuration.Parser%3CT%3E)) (String configKey, List<T> defaultValues, [Parser](./Configuration.Parser.md) <T> parser)  Allows for retrieving a parameter value that consists of a comma delimited list. |
| static <T> [ConfigValue](./ConfigValue.md) <List<T>> | [getMultiValue](./Configuration.md#getMultiValue(java.lang.String,%20java.util.List%3CT%3E,%20com.google.enterprise.cloudsearch.sdk.config.Configuration.Parser%3CT%3E,%20java.lang.String)) (String configKey, List<T> defaultValues, [Parser](./Configuration.Parser.md) <T> parser, String delimiter)  Allows for retrieving a parameter value that consists of a delimited list. |
| static <T> [ConfigValue](./ConfigValue.md) <T> | [getOverriden](./Configuration.md#getOverriden(java.lang.String,%20com.google.enterprise.cloudsearch.sdk.config.ConfigValue%3CT%3E)) (String configKey, [ConfigValue](./ConfigValue.md) <T> defaultValue)  Allows for chaining default configuration values. |
| static [ConfigValue](./ConfigValue.md) <String> | [getString](./Configuration.md#getString(java.lang.String,%20java.lang.String)) (String configKey, String defaultValue)  Get configuration values parsed as string for supplied configuration key. |
| static <T> [ConfigValue](./ConfigValue.md) <T> | [getValue](./Configuration.md#getValue(java.lang.String,%20T,%20com.google.enterprise.cloudsearch.sdk.config.Configuration.Parser%3CT%3E)) (String configKey, T defaultValue, [Parser](./Configuration.Parser.md) <T> parser)  Allows for creating custom type `ConfigValue` instances. |
| static void | [initConfig](./Configuration.md#initConfig(java.lang.String[])) (String\[\] args)  Initializes the `Configuration` instance using the properties file specified in the command line arguments. |
| synchronized static void | [initConfig](./Configuration.md#initConfig(java.util.Properties)) (Properties config)  Initializes the `Configuration` instance using the provided `Properties`. |
| static boolean | [isInitialized](./Configuration.md#isInitialized()) ()  Checks whether the `Configuration` is initialized. |
