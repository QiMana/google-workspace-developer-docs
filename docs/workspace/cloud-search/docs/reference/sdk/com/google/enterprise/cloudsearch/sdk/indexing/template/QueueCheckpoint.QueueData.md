---
source: https://developers.google.com/workspace/cloud-search/docs/reference/sdk/com/google/enterprise/cloudsearch/sdk/indexing/template/QueueCheckpoint.QueueData
root: workspace
fetched_at: 2026-04-23T15:26:51.993Z
---

# QueueCheckpoint.QueueData

Represents queue checkpoint information maintained by `FullTraversalConnector`
...
#### public QueueCheckpoint.QueueData ()
...
Gets resource name as returned by `deleteQueueItems(String)` long running operation.

##### Returns

- the resource name for `deleteQueueItems(String)` long running operation.
...
- queue name used for traversal.

#### public QueueCheckpoint.QueueData setOperationName (String operationName)

Gets resource name as returned by `deleteQueueItems(String)` long running operation.

##### Parameters

| operationName | the resource name for `deleteQueueItems(String)` long running operation. |
| --- | --- |

##### Returns

- this instance of `QueueCheckpoint.QueueData`

#### public QueueCheckpoint.QueueData setQueueName (String queueName)

Sets queue name used for traversal.

##### Parameters

| queueName | queue name used for traversal |
| --- | --- |
