---
source: https://developers.google.com/workspace/cloud-search/docs/reference/sdk/com/google/enterprise/cloudsearch/sdk/indexing/util/UploadRequest.UnreserveRequest
root: workspace
fetched_at: 2026-04-23T15:26:58.735Z
---

# UploadRequest.UnreserveRequest

Request to unreserve polled `Item` instances in a specific queue.

```
queue is the name of queue that is unreserved from.
```

An example of UnreserveRequest is:
...
[UploadRequest.UnreserveRequest](https://developers.google.com/workspace/cloud-search/docs/reference/sdk/com/google/enterprise/cloudsearch/sdk/indexing/util/UploadRequest.UnreserveRequest#UploadRequest.UnreserveRequest\(\)) ()
