---
source: https://developers.google.com/workspace/cloud-search/docs/reference/sdk/com/google/enterprise/cloudsearch/sdk/indexing/util/UploadRequest.PushItemRequest
root: workspace
fetched_at: 2026-04-23T15:26:59.485Z
---

# UploadRequest.PushItemRequest

Request to push item to the indexing API.

```
pushItem is the PushItem object to be pushed to the indexing API.
```

An example of PushItemRequest is:
