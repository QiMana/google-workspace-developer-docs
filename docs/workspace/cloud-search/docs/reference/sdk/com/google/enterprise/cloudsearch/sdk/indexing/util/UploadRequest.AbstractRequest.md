---
source: https://developers.google.com/workspace/cloud-search/docs/reference/sdk/com/google/enterprise/cloudsearch/sdk/indexing/util/UploadRequest.AbstractRequest
root: workspace
fetched_at: 2026-04-23T15:26:54.282Z
---

# UploadRequest.AbstractRequest
...
```
The valid types of requests are:
     
       items.delete: UploadRequest.DeleteRequest
       items.deleteQueueItems: UploadRequest.DeleteQueueItemsRequest
       items.get: UploadRequest.GetRequest
       items.indexItem: UploadRequest.IndexItemRequest
       items.indexItemAndContent: UploadRequest.IndexItemAndContentRequest
       items.pollItems: UploadRequest.PollItemsRequest
       items.pushItem: UploadRequest.PushItemRequest
       items.unreserve: UploadRequest.UnreserveRequest
       items.list: UploadRequest.ListRequest
       datasources.list: UploadRequest.DatasourcesListRequest
       schema.update: UploadRequest.UpdateSchemaRequest
       schema.get: UploadRequest.GetSchemaRequest
       schema.delete: UploadRequest.DeleteSchemaRequest
```
