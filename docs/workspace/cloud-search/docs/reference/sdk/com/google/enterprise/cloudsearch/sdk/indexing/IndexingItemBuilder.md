...
| String | [CONTAINER\_NAME\_FIELD](./IndexingItemBuilder.md#CONTAINER_NAME_FIELD) |  |
| --- | --- | --- |
| String | [CONTAINER\_NAME\_VALUE](./IndexingItemBuilder.md#CONTAINER_NAME_VALUE) |  |
| String | [CONTENT\_LANGUAGE\_FIELD](./IndexingItemBuilder.md#CONTENT_LANGUAGE_FIELD) |  |
| String | [CONTENT\_LANGUAGE\_VALUE](./IndexingItemBuilder.md#CONTENT_LANGUAGE_VALUE) |  |
| String | [CREATE\_TIME\_FIELD](./IndexingItemBuilder.md#CREATE_TIME_FIELD) |  |
| String | [CREATE\_TIME\_VALUE](./IndexingItemBuilder.md#CREATE_TIME_VALUE) |  |
| String | [HASH\_FIELD](./IndexingItemBuilder.md#HASH_FIELD) |  |
| String | [HASH\_VALUE](./IndexingItemBuilder.md#HASH_VALUE) |  |
| String | [MIME\_TYPE\_FIELD](./IndexingItemBuilder.md#MIME_TYPE_FIELD) |  |
| String | [MIME\_TYPE\_VALUE](./IndexingItemBuilder.md#MIME_TYPE_VALUE) |  |
| String | [OBJECT\_TYPE](./IndexingItemBuilder.md#OBJECT_TYPE) |  |
| String | [OBJECT\_TYPE\_FIELD](./IndexingItemBuilder.md#OBJECT_TYPE_FIELD) |  |
| String | [OBJECT\_TYPE\_VALUE](./IndexingItemBuilder.md#OBJECT_TYPE_VALUE) |  |
| String | [SEARCH\_QUALITY\_METADATA\_QUALITY\_FIELD](./IndexingItemBuilder.md#SEARCH_QUALITY_METADATA_QUALITY_FIELD) |  |
| String | [SEARCH\_QUALITY\_METADATA\_QUALITY\_VALUE](./IndexingItemBuilder.md#SEARCH_QUALITY_METADATA_QUALITY_VALUE) |  |
| String | [SOURCE\_REPOSITORY\_URL\_FIELD](./IndexingItemBuilder.md#SOURCE_REPOSITORY_URL_FIELD) |  |
| String | [SOURCE\_REPOSITORY\_URL\_VALUE](./IndexingItemBuilder.md#SOURCE_REPOSITORY_URL_VALUE) |  |
| String | [TITLE\_FIELD](./IndexingItemBuilder.md#TITLE_FIELD) |  |
| String | [TITLE\_VALUE](./IndexingItemBuilder.md#TITLE_VALUE) |  |
| String | [UPDATE\_TIME\_FIELD](./IndexingItemBuilder.md#UPDATE_TIME_FIELD) |  |
| String | [UPDATE\_TIME\_VALUE](./IndexingItemBuilder.md#UPDATE_TIME_VALUE) |  |

### Public Constructor Summary

[IndexingItemBuilder](./IndexingItemBuilder.md#IndexingItemBuilder(java.lang.String)) (String name)

Constructs an empty `IndexingItemBuilder`.

### Public Method Summary

| Item | [build](./IndexingItemBuilder.md#build()) ()  Builds the `Item` using all of the previously set attributes. |
| --- | --- |
| static [IndexingItemBuilder](./IndexingItemBuilder.md) | [fromConfiguration](./IndexingItemBuilder.md#fromConfiguration(java.lang.String)) (String name)  Constructs an `IndexingItemBuilder` from the `Configuration`. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setAcl](./IndexingItemBuilder.md#setAcl(com.google.enterprise.cloudsearch.sdk.indexing.Acl)) ([Acl](./Acl.md) acl)  Sets the `Acl` instance, which is used to construct the `ItemAcl`. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setContainerName](./IndexingItemBuilder.md#setContainerName(java.lang.String)) (String containerName)  *This method is deprecated. Use `setContainerName(FieldOrValue)` with `withValue(T)`* |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setContainerName](./IndexingItemBuilder.md#setContainerName(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Cjava.lang.String%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <String> containerName)  Sets the `containerName` field value for the `ItemMetadata`, either from the given field (or key) in the `values` multimap, or a literal value. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setContentLanguage](./IndexingItemBuilder.md#setContentLanguage(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Cjava.lang.String%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <String> language)  Sets the `contentLanguage` field value for the `ItemMetadata`, either from the given field (or key) in the `values` multimap, or a literal value. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setCreateTime](./IndexingItemBuilder.md#setCreateTime(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Ccom.google.api.client.util.DateTime%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <DateTime> createTime)  Sets the `createTime` field value for the `ItemMetadata`, either from the given field (or key) in the `values` multimap, or a literal value. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setHash](./IndexingItemBuilder.md#setHash(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Cjava.lang.String%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <String> hash)  Sets the `hash` field value for the `ItemMetadata`, either from the given field (or key) in the `values` multimap, or a literal value. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setHash](./IndexingItemBuilder.md#setHash(java.lang.String)) (String hash)  *This method is deprecated. Use `setHash(FieldOrValue)` with `withValue(T)`* |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setItemType](./IndexingItemBuilder.md#setItemType(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.ItemType)) ([IndexingItemBuilder.ItemType](./IndexingItemBuilder.ItemType.md) itemType)  Sets the `itemType` field value for the `Item`. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setMimeType](./IndexingItemBuilder.md#setMimeType(java.lang.String)) (String mimeType)  *This method is deprecated. Use `setMimeType(FieldOrValue)` with `withValue(T)`* |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setMimeType](./IndexingItemBuilder.md#setMimeType(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Cjava.lang.String%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <String> mimeType)  Sets the `mimeType` field value for the `ItemMetadata`, either from the given field (or key) in the `values` multimap, or a literal value. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setObjectType](./IndexingItemBuilder.md#setObjectType(java.lang.String)) (String objectType)  *This method is deprecated. Use `setObjectType(FieldOrValue)` with `withValue(T)`* |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setObjectType](./IndexingItemBuilder.md#setObjectType(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Cjava.lang.String%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <String> objectType)  Sets the name of the object definition from the schema to use when constructing the `ItemStructuredData`, either from the given field (or key) in the `values` multimap, or a literal value. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setPayload](./IndexingItemBuilder.md#setPayload(byte[])) (byte\[\] payload)  Sets the `payload` field value for the `Item`. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setQueue](./IndexingItemBuilder.md#setQueue(java.lang.String)) (String queue)  Sets the `queue` field value for the `Item`. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setSearchQualityMetadata](./IndexingItemBuilder.md#setSearchQualityMetadata(com.google.api.services.cloudsearch.v1.model.SearchQualityMetadata)) (SearchQualityMetadata searchQuality)  Sets the `searchQualityMetadata` field value for the `ItemMetadata`. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setSearchQualityMetadataQuality](./IndexingItemBuilder.md#setSearchQualityMetadataQuality(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Cjava.lang.Double%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <Double> quality)  Sets the `searchQualityMetadata.quality` field value for the `ItemMetadata`. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setSourceRepositoryUrl](./IndexingItemBuilder.md#setSourceRepositoryUrl(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Cjava.lang.String%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <String> url)  Sets the `sourceRepositoryUrl` field value for the `ItemMetadata`, either from the given field (or key) in the `values` multimap, or a literal value. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setTitle](./IndexingItemBuilder.md#setTitle(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Cjava.lang.String%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <String> title)  Sets the `title` field value for the `ItemMetadata`, either from the given field (or key) in the `values` multimap, or a literal value. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setUpdateTime](./IndexingItemBuilder.md#setUpdateTime(com.google.enterprise.cloudsearch.sdk.indexing.IndexingItemBuilder.FieldOrValue%3Ccom.google.api.client.util.DateTime%3E)) ([FieldOrValue](./IndexingItemBuilder.FieldOrValue.md) <DateTime> updateTime)  Sets the `updateTime` field value for the `ItemMetadata`, either from the given field (or key) in the `values` multimap, or a literal value. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setValues](./IndexingItemBuilder.md#setValues(com.google.common.collect.Multimap%3Cjava.lang.String,%20java.lang.Object%3E)) (Multimap<String, Object> values)  Sets the repository attributes that may be used for the `ItemMetadata` or `StructuredDataObject` fields, depending on the `FieldOrValue` setters called by the connector as well as the configuration. |
| [IndexingItemBuilder](./IndexingItemBuilder.md) | [setVersion](./IndexingItemBuilder.md#setVersion(byte[])) (byte\[\] version)  Sets the `version` field value for the `Item`. |
