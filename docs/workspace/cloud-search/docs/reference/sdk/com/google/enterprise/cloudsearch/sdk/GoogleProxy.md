...
| String | [TRANSPORT\_PROXY\_HOSTNAME\_KEY](./GoogleProxy.md#TRANSPORT_PROXY_HOSTNAME_KEY) | configuration key for proxy hostname |
| --- | --- | --- |
| String | [TRANSPORT\_PROXY\_PASSWORD\_KEY](./GoogleProxy.md#TRANSPORT_PROXY_PASSWORD_KEY) | configuration key for proxy password |
| String | [TRANSPORT\_PROXY\_PORT\_KEY](./GoogleProxy.md#TRANSPORT_PROXY_PORT_KEY) | configuration key for proxy port |
| String | [TRANSPORT\_PROXY\_TYPE\_KEY](./GoogleProxy.md#TRANSPORT_PROXY_TYPE_KEY) | configuration key for proxy type |
| String | [TRANSPORT\_PROXY\_USERNAME\_KEY](./GoogleProxy.md#TRANSPORT_PROXY_USERNAME_KEY) | configuration key for proxy username |

### Public Method Summary

| boolean | [equals](./GoogleProxy.md#equals(java.lang.Object)) (Object other) |
| --- | --- |
| static [GoogleProxy](./GoogleProxy.md) | [fromConfiguration](./GoogleProxy.md#fromConfiguration()) ()  Creates an `GoogleProxy` instance based on proxy configuration. |
| HttpRequestInitializer |  |
| HttpTransport | [getHttpTransport](./GoogleProxy.md#getHttpTransport()) ()  Gets an `HttpTransport` that contains the proxy configuration. |
| Proxy | [getProxy](./GoogleProxy.md#getProxy()) () |
| int | [hashCode](./GoogleProxy.md#hashCode()) () |
