...
root: workspace
fetched_at: 2026-04-23T15:31:58.217Z
---

# Go quickstart

Create a Go command-line application that makes requests to the Google Tasks API.
...
3. Initialize the new module:
	...
	```
4. Get the Google Tasks API Go client library and OAuth2.0 package:
	```
