---
source: https://developers.google.com/workspace/tasks/quickstart/js
root: workspace
fetched_at: 2026-04-23T15:31:59.788Z
---

# JavaScript quickstart

Create a JavaScript web application that makes requests to the Google Tasks API.
...
Your JavaScript application runs and calls the Google Tasks API.
