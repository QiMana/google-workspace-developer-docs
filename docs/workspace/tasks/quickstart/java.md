...
root: workspace
fetched_at: 2026-04-23T15:31:59.717Z
---
...
- [Tasks API reference documentation](../reference/rest.md)
- [Google APIs Client for Java documentation](https://developers.google.com/api-client-library/java)
- [Google Tasks API Javadoc documentation](https://googleapis.dev/java/google-api-services-tasks/latest/index.html)
