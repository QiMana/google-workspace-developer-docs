---
source: https://developers.google.com/workspace/tasks/auth
root: workspace
fetched_at: 2026-04-23T15:31:57.195Z
---

# Choose Google Tasks API scopes

This document contains Google Tasks API-specific authorization and authentication information. Before reading this document, be sure to read the Google Workspace's general authentication and authorization information at [Learn about authentication and authorization](../guides/auth-overview.md).
