---
source: https://developers.google.com/workspace/chat/api/reference/rpc/google.type
root: workspace
fetched_at: 2026-04-23T15:25:10.796Z
---
...
- Applications should assume the sRGB color space when interpreting the RGB values unless otherwise documented.
- Two colors are considered equal if their red, green, blue, and alpha values differ by at most `1e-5`.
- The `alpha` field, if omitted, defaults to 1.0, rendering the color as solid.
- Examples are provided for Java, iOS/Obj-C, and JavaScript demonstrating how to convert between `Color` and platform-specific color representations.
