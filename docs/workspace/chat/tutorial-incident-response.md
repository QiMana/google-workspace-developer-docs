---
source: https://developers.google.com/workspace/chat/tutorial-incident-response
root: workspace
fetched_at: 2026-04-23T15:25:36.262Z
---
...
9. Register a [quick command](../add-ons/chat/commands.md) that the fully implemented Chat app uses:
...
- [Answer questions based on Chat conversations with a Gemini AI Chat app](../add-ons/samples/tutorial-ai-knowledge-assistant.md)
- [Manage projects with Google Chat, Vertex AI, and Firestore](../add-ons/samples/tutorial-project-management.md)
