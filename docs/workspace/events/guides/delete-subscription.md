...
This page explains how to delete a Google Workspace subscription using the [`subscriptions.delete()`](../reference/rest/v1/subscriptions/delete.md) method.
...
The following code sample deletes a [`Subscription`](../reference/rest/v1/subscriptions.md) resource using user authentication.
