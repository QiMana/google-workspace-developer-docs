---
source: https://developers.google.com/workspace/events/reference/rest/v1beta/subscriptions
root: workspace
fetched_at: 2026-04-23T15:28:38.060Z
---
...
<table><colgroup><col width="25%"> <col></colgroup><thead><tr><th colspan="2">Fields</th></tr></thead><tbody><tr><td><code>includeDescendants</code></td><td><p><code>boolean</code></p><p>Optional. Immutable. For subscriptions to Google Drive events, whether to receive events about Drive files that are children of the target folder or shared drive.</p><ul><li>If <code>false</code>, the subscription only receives events about changes to the folder or shared drive that's specified as the <code><code>targetResource</code></code>.</li><li>If <code>true</code>, the <code>mimeType</code> field of the <code>file</code> resource must be set to <code>application/vnd.google-apps.folder</code>.</li></ul><p>For details, see <a href="https://developers.google.com/workspace/events/guides/events-drive#event-types">Google Drive event types</a>.</p></td></tr></tbody></table>
