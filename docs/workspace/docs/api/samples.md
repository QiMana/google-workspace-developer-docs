---
source: https://developers.google.com/workspace/docs/api/samples
root: workspace
fetched_at: 2026-04-23T15:27:15.483Z
---
...
[Create a transcript of your business meetings using Google Docs & Machine Learning](https://codelabs.developers.google.com/codelabs/docs-ml-transcript#0): In this codelab, you'll learn how to send an audio file through the [Google Cloud Speech-to-Text API](https://cloud.google.com/speech-to-text/), then output the transcript to a Google document. The Speech-to-Text API is easy-to-use and applies a powerful neural network to enable developers to convert audio to text. Plus, it's powered by Machine Learning.
