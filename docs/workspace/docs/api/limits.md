...
root: workspace
fetched_at: 2026-04-23T15:27:06.720Z
---
...
If you exceed a quota, you'll generally receive a `429: Too many requests` HTTP status code response. If this happens, you should use an [exponential backoff algorithm](#exponential) and try again later.

The following table details the request limits:

<table><thead><tr><th colspan="2">Quotas</th></tr></thead><tbody><tr><td>Read requests</td><td><table><tbody><tr><td>Per minute per project</td><td>3000</td></tr><tr><td>Per minute per user per project</td><td>300</td></tr></tbody></table></td></tr><tr><td>Write requests</td><td><table><tbody><tr><td>Per minute per project</td><td>600</td></tr><tr><td>Per minute per user per project</td><td>60</td></tr></tbody></table></td></tr></tbody></table>
