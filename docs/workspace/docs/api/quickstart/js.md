...
root: workspace
fetched_at: 2026-04-23T15:27:13.346Z
---

# JavaScript quickstart

Create a JavaScript web application that makes requests to the Google Docs API.
...
Your JavaScript application runs and calls the Google Docs API.
