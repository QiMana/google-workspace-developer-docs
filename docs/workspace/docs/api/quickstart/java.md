...
root: workspace
fetched_at: 2026-04-23T15:27:08.568Z
---

# Java quickstart

Create a Java command-line application that makes requests to the Google Docs API.
...
2. The first time you run the sample, it prompts you to authorize access:
	1. If you're not already signed in to your Google Account, sign in when prompted. If you're signed in to multiple accounts, select one account to use for authorization.
		2. Click **Accept**.
	Your Java application runs and calls the Google Docs API.
...
- [Google Docs API Javadoc documentation](https://googleapis.dev/java/google-api-services-docs/latest/index.html)
