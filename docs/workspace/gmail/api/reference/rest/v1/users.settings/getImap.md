---
source: https://developers.google.com/workspace/gmail/api/reference/rest/v1/users.settings/getImap
root: workspace
fetched_at: 2026-04-23T15:29:05.068Z
---

# Method: users.settings.getImap

Gets IMAP settings. For more information, see [Configure POP and IMAP settings with the Gmail API](../../../../guides/pop_imap_settings.md).
