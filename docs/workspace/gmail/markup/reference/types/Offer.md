...
| addOn | [Offer](./Offer.md) | An additional offer that can only be obtained in combination with the first base offer (e.g. supplements and extensions that are available for a surcharge). |
...
| ineligibleRegion | [Place](./Place.md) | The place(s) from which the offer cannot be obtained (e.g. a region where the transaction is not allowed). |
...
| priceValidUntil | [Date](./Date.md) | The date after which the price is no longer available. |
