...
Type name: [FlightReservation](./types/FlightReservation.md)

Extends [Reservation](./types/Reservation.md)

| Name | Type | Description |
| --- | --- | --- |
| **additionalTicketText** | [Text](./types/Text.md) | Additional information about the boarding pass. |
| **airplaneSeat** | [Text](./types/Text.md) | The location of the reserved seat (e.g., 27B). |
| **airplaneSeatClass** |  | The cabin/class of the airplaneSeat. |
| airplaneSeatClass.**name** | [Text](./types/Text.md) | Name of the AirplaneSeatClass. |
| **boardingGroup** | [Text](./types/Text.md) | The airline-specific indicator of boarding order / preference. |
...
| **potentialAction** | , [ConfirmAction](./types/ConfirmAction.md), [CancelAction](./types/CancelAction.md) or [CheckInAction](./types/CheckInAction.md) | Action that can be performed on the reservation. |
| potentialAction.**target** | [EntryPoint](./types/EntryPoint.md) | Specifies a handler to process the action, typically a simple URL. |
...
| **reservationFor****   (Required)** | [Flight](./types/Flight.md) | The flight the reservation is for. |
| reservationFor.**airline****   (Required)** | [Airline](./types/Airline.md) | The airline providing the flight. |
| reservationFor.airline.**iataCode****   (Required)** | [Text](./types/Text.md) | The IATA code for the airline. |
| reservationFor.airline.**name****   (Required)** | [Text](./types/Text.md) | Name of the Airline. |
| reservationFor.**arrivalAirport****   (Required)** | [Airport](./types/Airport.md) | The final destination of the flight. Also accepts a string (e.g. "John F. Kennedy International Airport JFK"). |
| reservationFor.arrivalAirport.**iataCode****   (Required)** | [Text](./types/Text.md) | The IATA code for the airport (e.g. 'UA'). |
| reservationFor.arrivalAirport.**name****   (Required)** | [Text](./types/Text.md) | Name of the Airport. |
| reservationFor.**arrivalGate** | [Text](./types/Text.md) | Identifier of the airport arrival gate of the flight. |
| reservationFor.**arrivalTerminal** | [Text](./types/Text.md) | The airport terminal of the arrivalGate. |
| reservationFor.**arrivalTime****   (Required)** | [DateTime](./types/DateTime.md) | Expected time of arrival. |
| reservationFor.**boardingTime** | [DateTime](./types/DateTime.md) | Time when boarding will commence. |
| reservationFor.**departureAirport****   (Required)** | [Airport](./types/Airport.md) | The departure airport for the flight. Also accepts a string (e.g. "San Francisco Airport SFO"). |
| reservationFor.departureAirport.**iataCode****   (Required)** | [Text](./types/Text.md) | The IATA code for the airport (e.g. 'UA'). |
| reservationFor.departureAirport.**name****   (Required)** | [Text](./types/Text.md) | Name of the Airport. |
| reservationFor.**departureGate** | [Text](./types/Text.md) | Identifier of the airport departure gate of the flight. |
| reservationFor.**departureTerminal** | [Text](./types/Text.md) | The airport terminal of the departureGate. |
| reservationFor.**departureTime****   (Required)** | [DateTime](./types/DateTime.md) | Expected time of departure. |
| reservationFor.**flightNumber****   (Required)** | [Text](./types/Text.md) | Flight identifier. |
| reservationFor.**operatedBy** | [Airline](./types/Airline.md) | The airline operating the flight. |
| reservationFor.operatedBy.**iataCode** | [Text](./types/Text.md) | The IATA code for the airline. |
| reservationFor.operatedBy.**name** | [Text](./types/Text.md) | Name of the Airline. |
| reservationFor.**webCheckinTime** | [DateTime](./types/DateTime.md) | Earliest time for web checking. |
...
| **ticketDownloadUrl** | [URL](./types/URL.md) | Where the boarding pass can be downloaded. |
| **ticketNumber** | [Text](./types/Text.md) | The number or id of the ticket. |
| **ticketPrintUrl** | [URL](./types/URL.md) | Where the boarding pass can be printed. |
...
| **underName****   (Required)** | [Organization](./types/Organization.md) or [Person](./types/Person.md) | The passenger. |
