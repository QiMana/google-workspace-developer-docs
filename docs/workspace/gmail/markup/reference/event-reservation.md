...
Type name: [EventReservation](./types/EventReservation.md)

Extends [Reservation](./types/Reservation.md)

| Name | Type | Description |
| --- | --- | --- |
| **action** | [Action](./types/Action.md) | An action that can be taken upon this thing. |
| action.**name** | [Text](./types/Text.md) | The string shown to the user on the UI element tied to the action. |
| action.**url** | [URL](./types/URL.md) | Target url for the action. If no explicit handler field is provided the action handler is expanded into a WebActionHandler with this url as the WebActionHandler url. |
| **additionalTicketText** | [Text](./types/Text.md) | Additional information about the ticket. |
...
| bookingAgent.**image** | [URL](./types/URL.md) | URL of an image of the Organization. |
...
| **numSeats** | [Number](./types/Number.md) | The number of seats. |
| **price** | [Text](./types/Text.md) | Total price of the EventReservation. |
| **priceCurrency** | [Text](./types/Text.md) | The currency (in 3-letter ISO 4217 format) of the EventReservation's price. |
...
| **reservationFor****   (Required)** | [Event](./types/Event.md) | Can use Event, or any of the event subtypes, including BusinessEvent, ChildrenEvent, ComedyEvent, DanceEvent, EducationEvent, Festival, FoodEvent, LiteraryEvent, MovieShowing, MusicEvent, SaleEvent, SocialEvent, SportsEvent, TheaterEvent, VisualArtsEvent. |
| reservationFor.**description** | [Text](./types/Text.md) | A short description of the Event. |
| reservationFor.**doorTime** | [DateTime](./types/DateTime.md) | The time admission will commence. |
| reservationFor.**endDate** | [DateTime](./types/DateTime.md) | The end date and time of the event. |
| reservationFor.**image** | [URL](./types/URL.md) | URL of an image of the Event. |
| reservationFor.**location****   (Required)** | [Place](./types/Place.md) | The event's location. |
| reservationFor.location.**address****   (Required)** | [PostalAddress](./types/PostalAddress.md) | Address of the the event's location. |
| reservationFor.location.address.**addressCountry****   (Required)** | [Text](./types/Text.md) or [Country](./types/Country.md) | Country of the event's location. |
| reservationFor.location.address.**addressLocality****   (Required)** | [Text](./types/Text.md) | Locality (e.g. city) of the event's location. |
| reservationFor.location.address.**addressRegion****   (Required)** | [Text](./types/Text.md) | Region (e.g. State) of the event's location. |
| reservationFor.location.address.**postalCode****   (Required)** | [Text](./types/Text.md) | Postal code of the event's location. |
| reservationFor.location.address.**streetAddress****   (Required)** | [Text](./types/Text.md) | Street address of the event's location. |
| reservationFor.location.**name****   (Required)** | [Text](./types/Text.md) | Name of the the event's location. |
| reservationFor.**name****   (Required)** | [Text](./types/Text.md) | Event's name. |
| reservationFor.**performer** | [Person](./types/Person.md) or [Organization](./types/Organization.md) | (recommended for Confirmation Cards/Search Answers) The event's performer. Also accepts an array of objects. |
| reservationFor.performer.**image** | [URL](./types/URL.md) | (recommended for Confirmation Cards/Search Answers) URL of an image of the Person. |
| reservationFor.performer.**name** | [Text](./types/Text.md) | (recommended for Confirmation Cards/Search Answers) Name of the Person. |
| reservationFor.performer.**url** | [URL](./types/URL.md) | URL of the Person. |
| reservationFor.**startDate****   (Required)** | [DateTime](./types/DateTime.md) | The start date and time of the event. |
| reservationFor.**url** | [URL](./types/URL.md) | URL of the Event. |
...
| **ticketDownloadUrl** | [URL](./types/URL.md) | Where the ticket can be downloaded. |
| **ticketNumber** | [Text](./types/Text.md) | The number or id of the ticket. |
| **ticketPrintUrl** | [URL](./types/URL.md) | Where the ticket can be printed. |
| **ticketToken** | [Text](./types/Text.md) or [URL](./types/URL.md) | If the barcode image is hosted on your site, the value of the field is URL of the image, or a barcode or QR URI, such as "barcode128:AB34" (ISO-15417 barcodes), "qrCode:AB34" (QR codes), "aztecCode:AB34" (Aztec codes), "barcodeEAN:1234" (EAN codes) and "barcodeUPCA:1234" (UPCA codes). |
| **underName****   (Required)** | [Person](./types/Person.md) or [Organization](./types/Organization.md) | The ticket holder. |
...
| **venueRow** | [Text](./types/Text.md) | The seat's row. |
| **venueSeat** | [Text](./types/Text.md) | The seat number. |
| **venueSection** | [Text](./types/Text.md) | The seat's section. |
