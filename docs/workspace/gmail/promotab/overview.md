...
This page explains how to annotate emails using [JSON-LD](https://developers.google.com/workspace/gmail/markup/reference/formats/json-ld) and [Microdata](https://developers.google.com/workspace/gmail/markup/reference/formats/microdata). To learn more about email markup, review the [Getting Started](https://developers.google.com/workspace/gmail/markup/getting-started) guide. For a list of markup fields that you can use in email annotations, visit the [reference documentation](https://developers.google.com/workspace/gmail/promotab/reference).
...
2. In the `head` section, add a `script` tag. For each image in your product carousel, add a [`PromotionCard`](https://developers.google.com/workspace/gmail/promotab/reference#promotioncard) object:
	### JSON-LD
	```
...
You can use this feature for a single image. All recipients must receive the same image and image URL. See our [frequently-asked-questions](https://developers.google.com/workspace/gmail/promotab/faq) documentation for more information.

To create a single image preview:

1. In your marketing email platform, create an email and open the email's HTML editor.
2. In the `head` section, add a `script` tag that includes the data type [`PromotionCard`](https://developers.google.com/workspace/gmail/promotab/reference#promotioncard):
	### JSON-LD
	```
	<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN">
	<html>
...
1. **Add the schema to your email's HTML**: In your marketing email platform, open the HTML editor for your campaign. In the `head` section, add a `script` tag that include the data type [`DiscountOffer`](https://developers.google.com/workspace/gmail/promotab/reference#discountoffer) with the following structure:
	### JSON-LD
	```
	<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN">
	<html>
...
4. **Validate and preview your card**: before sending your campaign, validate your code and see a [preview](https://developers.google.com/workspace/gmail/promotab/preview) of how your Deal Annotation will look.
...
- View the [reference documentation](https://developers.google.com/workspace/gmail/promotab/reference) to learn about the available email markup fields.
- Learn about [best practices](https://developers.google.com/workspace/gmail/promotab/best-practices) for email annotations.
