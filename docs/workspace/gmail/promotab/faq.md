---
source: https://developers.google.com/workspace/gmail/promotab/faq
root: workspace
fetched_at: 2026-04-23T15:30:05.963Z
---
...
No, email messages in bundles and rich previews are for organic email and therefore it is free. The only paid way to have visibility in consumer (free) version of Gmail continues to be [Gmail Ads](https://support.google.com/google-ads/answer/7019460). Google Workspace Gmail is ad-free.
...
No. All features are optional. We recommend using at least single image features for increased visibility of your email.
...
No, all marketing email can be annotated, and you can freely mix and match features. For example, if your email is not about a deal or a discount, but rather a product promotion, you can still use your product image to annotate your email.
