...
You can use most of the generic trigger types available to Google Apps Script projects in Editor add-ons, including [simple triggers](https://developers.google.com/apps-script/guides/triggers) and most [installable triggers](https://developers.google.com/apps-script/guides/triggers/installable). The exact set of available trigger types depends on the application being extended.

Unlike Editor add-ons, Google Workspace add-ons can't use generic Apps Script simple or installable triggers. Instead, they use triggers designed specifically for Google Workspace add-ons. For more information, see [Google Workspace add-ons triggers](https://developers.google.com/workspace/add-ons/concepts/workspace-triggers).
...
| Event | [Event object](https://developers.google.com/apps-script/guides/triggers/events) | [Simple triggers](#simple_triggers_in_add-ons) | [Installable triggers](#installable_triggers_in_add-ons) |
| --- | --- | --- | --- |
| **Open**   An editor file is opened. | [Docs onOpen event object](https://developers.google.com/apps-script/guides/triggers/events#open_1)   [Forms onOpen event object](https://developers.google.com/apps-script/guides/triggers/events#open_3)   [Sheets onOpen event object](https://developers.google.com/apps-script/guides/triggers/events#open)   [Slides onOpen event object](https://developers.google.com/apps-script/guides/triggers/events#open_2) | ![](https://fonts.gstatic.com/s/i/productlogos/docs_2020q4/v6/web-48dp/logo_docs_2020q4_color_1x_web_48dp.png) Docs   ![](https://fonts.gstatic.com/s/i/productlogos/forms_2020q4/v4/web-48dp/logo_forms_2020q4_color_1x_web_48dp.png) Forms\*   ![](https://fonts.gstatic.com/s/i/productlogos/sheets_2020q4/v5/web-48dp/logo_sheets_2020q4_color_1x_web_48dp.png) Sheets   ![](https://fonts.gstatic.com/s/i/productlogos/slides_2020q4/v6/web-48dp/logo_slides_2020q4_color_1x_web_48dp.png) Slides    `function onOpen(e)` | ![](https://fonts.gstatic.com/s/i/productlogos/docs_2020q4/v6/web-48dp/logo_docs_2020q4_color_1x_web_48dp.png) Docs   ![](https://fonts.gstatic.com/s/i/productlogos/forms_2020q4/v4/web-48dp/logo_forms_2020q4_color_1x_web_48dp.png) Forms   ![](https://fonts.gstatic.com/s/i/productlogos/sheets_2020q4/v5/web-48dp/logo_sheets_2020q4_color_1x_web_48dp.png) Sheets |
| **Install**   The add-on is installed. | [onInstall event object](https://developers.google.com/apps-script/guides/triggers/events#install) | ![](https://fonts.gstatic.com/s/i/productlogos/docs_2020q4/v6/web-48dp/logo_docs_2020q4_color_1x_web_48dp.png) Docs   ![](https://fonts.gstatic.com/s/i/productlogos/forms_2020q4/v4/web-48dp/logo_forms_2020q4_color_1x_web_48dp.png) Forms   ![](https://fonts.gstatic.com/s/i/productlogos/sheets_2020q4/v5/web-48dp/logo_sheets_2020q4_color_1x_web_48dp.png) Sheets   ![](https://fonts.gstatic.com/s/i/productlogos/slides_2020q4/v6/web-48dp/logo_slides_2020q4_color_1x_web_48dp.png) Slides    `function onInstall(e)` |  |
| **Edit**   Spreadsheet cell content is changed. | [Sheets onEdit event object](https://developers.google.com/apps-script/guides/triggers/events#edit) | ![](https://fonts.gstatic.com/s/i/productlogos/sheets_2020q4/v5/web-48dp/logo_sheets_2020q4_color_1x_web_48dp.png) Sheets    `function onEdit(e)` | ![](https://fonts.gstatic.com/s/i/productlogos/sheets_2020q4/v5/web-48dp/logo_sheets_2020q4_color_1x_web_48dp.png) Sheets |
| **Change**   Content in a sheet is edited or formatted. | [Sheets onChange event object](https://developers.google.com/apps-script/guides/triggers/events#change) |  | ![](https://fonts.gstatic.com/s/i/productlogos/sheets_2020q4/v5/web-48dp/logo_sheets_2020q4_color_1x_web_48dp.png) Sheets |
| **Form-submit**   A Google Form is submitted. | [Forms form-submit event object](https://developers.google.com/apps-script/guides/triggers/events#form-submit_4)   [Sheets form-submit event object](https://developers.google.com/apps-script/guides/triggers/events#form-submit) |  | ![](https://fonts.gstatic.com/s/i/productlogos/forms_2020q4/v4/web-48dp/logo_forms_2020q4_color_1x_web_48dp.png) Forms   ![](https://fonts.gstatic.com/s/i/productlogos/sheets_2020q4/v5/web-48dp/logo_sheets_2020q4_color_1x_web_48dp.png) Sheets |
| **Time-driven (clock)**   The trigger fires at a specified time or interval. | [Time-driven event object](https://developers.google.com/apps-script/guides/triggers/events#time-driven_events) | ![](https://fonts.gstatic.com/s/i/productlogos/docs_2020q4/v6/web-48dp/logo_docs_2020q4_color_1x_web_48dp.png) Docs   ![](https://fonts.gstatic.com/s/i/productlogos/forms_2020q4/v4/web-48dp/logo_forms_2020q4_color_1x_web_48dp.png) Forms   ![](https://fonts.gstatic.com/s/i/productlogos/sheets_2020q4/v5/web-48dp/logo_sheets_2020q4_color_1x_web_48dp.png) Sheets   ![](https://fonts.gstatic.com/s/i/productlogos/slides_2020q4/v6/web-48dp/logo_slides_2020q4_color_1x_web_48dp.png) Slides |
...
[Simple triggers](https://developers.google.com/apps-script/guides/triggers) use a set a reserved function names, can't use services that require authorization, and are automatically enabled for use. In some cases, a simple trigger event can be handled by an [installable trigger](#installable_triggers_in_add-ons) instead.

You can add a simple trigger to an add-on by implementing a function with one of the following reserved names:

- `onOpen` executes when a user opens a document, spreadsheet, or presentation. `onOpen` also can execute when a form is opened in the editor (but not when responding to the form). It only executes if the user has permission to edit the file in question, and is most often used to create [menu items](https://developers.google.com/workspace/add-ons/concepts/menus).
...
Simple triggers in add-ons are subject to the same [restrictions](https://developers.google.com/apps-script/guides/triggers#restrictions) that govern simple triggers in other kinds of Apps Script projects. Take particular note of these restrictions when designing add-ons:
...
- In certain circumstances, Editor add-ons run their `onOpen` and `onEdit` simple triggers in a no-authorization mode. This mode presents complications as outlined in the [add-on authorization model](https://developers.google.com/workspace/add-ons/concepts/editor-auth-lifecycle#authorization_model).
- Simple triggers cannot use [services](https://developers.google.com/apps-script/guides/services) or take other actions that require [authorization](https://developers.google.com/apps-script/guides/services/authorization), except as outlined in the [add-on authorization model](https://developers.google.com/workspace/add-ons/concepts/editor-auth-lifecycle#authorization_model).
...
Add-ons can [programmatically create and modify installable triggers](https://developers.google.com/apps-script/guides/triggers/installable#managing_triggers_programmatically) with the Apps Script [`Script`](https://developers.google.com/apps-script/reference/script) service. add-on installable triggers can't be created manually. Unlike simple triggers, installable triggers can use services that require authorization.

Installable triggers in add-ons don't send [error emails](https://developers.google.com/apps-script/guides/triggers/installable#errors_in_triggers) to the user when they encounter errors, since in most cases a user is unable to address the problem. Because of this, you should design your add-on to gracefully handle errors on behalf of the user whenever possible.
...
- **Form-submit** installable triggers execute when a Google Form response is submitted.
	There are two versions of form-submit triggers: one for Sheets (where form responses are collected) and one for Google Forms. The [event object passed to a Sheets form-submit trigger function](https://developers.google.com/apps-script/guides/triggers/events#form-submit) is simpler and returns the response values in simple arrays. The [event object passed to a Forms form-submit trigger function](https://developers.google.com/apps-script/guides/triggers/events#form-submit_4) provides more information, contained in a [`FormResponse`](https://developers.google.com/apps-script/reference/forms/form-response) object.
- [**Time-driven triggers**](https://developers.google.com/apps-script/guides/triggers/installable#time-driven_triggers) (also called clock triggers) fire at a specific time or repeatedly on a regular time interval.
...
Installable triggers in add-ons are subject to the same [restrictions](https://developers.google.com/apps-script/guides/triggers/installable#restrictions) that govern installable triggers in other kinds of Apps Script projects.
