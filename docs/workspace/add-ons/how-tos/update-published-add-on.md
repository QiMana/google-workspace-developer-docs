...
To change or unpublish the Google Workspace Marketplace listing, see [Update, unpublish, or check publication status](https://developers.google.com/workspace/marketplace/manage-app-listing). To deploy a new version of add-on code, follow these steps:
...
4. If you add scopes in the manifest, follow these steps:
	1. Update the [scopes listed in the Google Workspace Marketplace SDK](https://developers.google.com/workspace/marketplace/enable-configure-sdk#oauth_scopes) and the OAuth consent screen to match the manifest.
...
To learn more, see [Versions](https://developers.google.com/apps-script/guides/versions).
