...
An [add-on action](https://developers.google.com/workspace/add-ons/chat/build#actions) that updates Google Workspace data.
...
The link object for the third-party resource that's returned to the add-on. For more information, see [Create third-party resources from the @ menu](https://developers.google.com/workspace/add-ons/guides/create-insert-resource-smart-chip).
...
Card action that previews a third-party link by displaying a card and smart chip. To learn more, see [Preview links with smart chips](https://developers.google.com/workspace/add-ons/guides/preview-links-smart-chips).
...
For [add-ons in Google Chat](https://developers.google.com/workspace/add-ons/chat), updates a card based on a user interaction. The array must only contain a single object.
...
For [add-ons in Google Chat](https://developers.google.com/workspace/add-ons/chat), updates a widget in a card or dialog. It is used for providing auto-complete suggestions when user types in an input box. See [Suggest multiselect items](https://developers.google.com/workspace/add-ons/chat/collect-information#suggest-multiselect) for more details.
...
Updates or [navigates between cards](https://developers.google.com/workspace/add-ons/how-tos/navigation) in a card stack.
...
For [add-ons in Google Chat](https://developers.google.com/workspace/add-ons/chat/), displays a notification when users submit and close a [dialog](https://developers.google.com/workspace/add-ons/chat/dialogs).
...
The [actions](https://developers.google.com/workspace/add-ons/concepts/actions) that add-ons can use in cards or the host application.
...
When unbundled oAuth consent is enabled, the HTTP add-on might need to request more Google oAuth scopes. The add-on should return this object to render the authorization card. See [`Manage granular           permissions`](https://developers.google.com/workspace/add-ons/guides/alternate-runtimes#manage-granular).
