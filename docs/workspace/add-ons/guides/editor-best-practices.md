...
When [testing your add-on](../how-tos/testing-editor-addons.md), be sure to try configurations that have different files and different [authorization states](../concepts/editor-auth-lifecycle.md#states).
