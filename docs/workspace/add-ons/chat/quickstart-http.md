...
The Chat app's [message](https://developers.google.com/workspace/add-ons/chat/send-messages) contains a card that displays the sender's name and avatar image, as demonstrated in the following image:
