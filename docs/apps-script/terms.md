...
If you use Scripts to create and publish [add-ons](https://developers.google.com/gsuite/add-ons/overview) (“Add-ons”) in the Add-ons store, you agree to the [Chrome Web Store Terms of Service](https://developers.google.com/chrome/web-store/terms).
