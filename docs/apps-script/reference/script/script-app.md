---
source: https://developers.google.com/apps-script/reference/script/script-app
root: apps-script
fetched_at: 2026-04-23T15:20:58.648Z
---
...
See the [OpenID Connect](https://developers.google.com/identity/protocols/OpenIDConnect#obtainuserinfo) documentation for the full list of fields (claims) returned.

#### Return

`String|null` — The identity token if available; otherwise `null`.
...
[`Error`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) — when invalidation fails
