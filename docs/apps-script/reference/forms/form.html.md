---
source: https://developers.google.com/apps-script/reference/forms/form.html
root: apps-script
fetched_at: 2026-04-23T15:20:20.711Z
---
...
[`Error`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) — if no item exists at the given index
...
[`Error`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) — if the item does not exist in the form
...
| Name | Type | Description |
| --- | --- | --- |
| `responseId` | `String` | The ID of the form response to delete. |
...
`Item|null` — The item with the given ID, or `null` if the item does not exist in the form.
...
[`Error`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) — if called on unsupported forms.
...
[`Error`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) — if enabled on an unpublished form.
...
| Name | Type | Description |
| --- | --- | --- |
| `responses` | `FormResponse[]` | An array of all of the form's responses. |
...
| Name | Type | Description |
| --- | --- | --- |
| `requireLogin` | `Boolean` | `true` if the form requires users to log in; `false` if it doesn't. |
