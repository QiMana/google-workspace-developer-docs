---
source: https://developers.google.com/apps-script/reference/gmail/gmail-attachment.html
root: apps-script
fetched_at: 2026-04-23T15:20:31.618Z
---
...
- The `getSize()` and `getHash()` methods for Gmail attachments do not count against the Gmail read quota and require specific authorization scopes.
