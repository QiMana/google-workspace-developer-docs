---
source: https://developers.google.com/apps-script/reference/contacts/date-field
root: apps-script
fetched_at: 2026-04-23T15:19:24.487Z
---
...
- DateField is a deprecated class used only by the Contacts service to represent a date field in a Contact.
- Instead of DateField, the People API advanced service should be used.
- Dates in App Script outside the Contacts service use JavaScript's standard Date object.
- The DateField class has methods to get and set its label.
- Most methods of the DateField class are deprecated, including those for getting and setting the day, month, and year, and for deleting the date field.
...
This class is only used by the Contacts service, and dates used elsewhere in App Script use JavaScript's standard [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) object.
...
Note: For standard JavaScript Date objects the [`getDay()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/getDay) method returns the day of the week instead.
