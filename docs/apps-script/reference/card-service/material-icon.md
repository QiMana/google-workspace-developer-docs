---
source: https://developers.google.com/apps-script/reference/card-service/material-icon
root: apps-script
fetched_at: 2026-04-23T15:19:09.171Z
---
...
- The appearance of the icon can be customized using methods like `setFill()`, `setGrade()`, and `setWeight()`.
- `setFill()` determines if the icon is solid, while `setGrade()` and `setWeight()` affect the thickness of the icon.
...
To preview different icon settings, go to [Google Font Icons](https://fonts.google.com/icons) and adjust the settings under **Customize**.
...
The icon name defined in [Google Font Icon](https://fonts.google.com/icons), For example, `check_box`.
