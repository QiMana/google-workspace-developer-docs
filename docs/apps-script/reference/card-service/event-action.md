...
An EventAction to run when a [CEL expression validation](../../../workspace/add-ons/studio/validate-inputs.md#cel-validation) condition is met.
...
Adds a [CEL expression validation](../../../workspace/add-ons/studio/validate-inputs.md#cel-validation) condition to evaluate after the event action runs.
...
Sets the [CEL expression validation](../../../workspace/add-ons/studio/validate-inputs.md#cel-validation) data action for widgets.
