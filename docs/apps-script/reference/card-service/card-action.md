---
source: https://developers.google.com/apps-script/reference/card-service/card-action
root: apps-script
fetched_at: 2026-04-23T15:18:59.496Z
---
...
- The text displayed in the card header menu for the CardAction is set using the `setText()` method.
