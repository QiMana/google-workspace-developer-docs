---
source: https://developers.google.com/apps-script/reference/card-service/chat-response-builder
root: apps-script
fetched_at: 2026-04-23T15:19:00.659Z
---
...
| --- | --- | --- |
| `cardWithId` | `CardWithId` | The `CardWithId` to use. |
...
| Name | Type | Description |
| --- | --- | --- |
| `actionResponse` | `ChatActionResponse` | The `ChatActionResponse` to use. |
