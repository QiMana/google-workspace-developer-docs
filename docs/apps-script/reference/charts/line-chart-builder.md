---
source: https://developers.google.com/apps-script/reference/charts/line-chart-builder
root: apps-script
fetched_at: 2026-04-23T15:19:19.185Z
---
...
- LineChartBuilder is used to create line charts and offers various methods for customization.
- Data for the line chart can be imported from external sources like Google Sheets using a data source URL.
- You can set visual properties of the chart such as title, axis titles, dimensions, colors, curve style, and point style.
- Methods are available to control the appearance of the legend and axis text, including text style and position.
- Advanced options and logarithmic scale for the range axis can also be configured.

Builder for line charts. For more details, see the [Google Charts documentation](https://developers.google.com/chart/interactive/docs/gallery/linechart).

Here is an example that shows how to build a line chart. The data is [imported from a Google spreadsheet](https://developers.google.com/chart/interactive/docs/spreadsheets#Google_Spreadsheets_as_a_Data_Source).
...
| Name | Type | Description |
| --- | --- | --- |
| `style` | `CurveStyle` | The style for curves in the chart. |
...
Sets advanced options for this chart. See [the available options for this chart](https://developers.google.com/chart/interactive/docs/gallery/linechart). This method has no effect if the given option is invalid.
