---
source: https://developers.google.com/apps-script/reference/spreadsheet/embedded-histogram-chart-builder
root: apps-script
fetched_at: 2026-04-23T15:21:33.712Z
---
...
- EmbeddedHistogramChartBuilder is a builder specifically for histogram charts.
- It provides methods to add, remove, and clear data ranges for the chart.
- The builder allows setting various visual and structural options like colors, titles, legend position, and axis styles.
- You can also change the chart type to other formats like Area, Bar, Column, Combo, Line, Pie, Scatter, or Table charts using specific methods.
- The `build()` method finalizes the chart configuration, which then needs to be inserted or updated in a sheet.
...
`EmbeddedHistogramChartBuilder` — This builder, useful for chaining.
