---
source: https://developers.google.com/apps-script/reference/spreadsheet/embedded-combo-chart-builder
root: apps-script
fetched_at: 2026-04-23T15:21:34.398Z
---
...
- EmbeddedComboChartBuilder is a builder specifically for combo charts.
- It provides methods to add, remove, and clear data ranges for the chart.
- You can change the chart type to various options like AreaChart, BarChart, ColumnChart, etc., using the `as` methods.
- The builder allows customization of chart appearance including background color, colors of lines, legend position and style, axis titles and styles, and setting a chart title.
- Methods are available to control data handling like setting the number of headers, merge strategy, and hidden dimension strategy, as well as transposing rows and columns and using a logarithmic scale.
...
`EmbeddedComboChartBuilder` — This builder, useful for chaining.
