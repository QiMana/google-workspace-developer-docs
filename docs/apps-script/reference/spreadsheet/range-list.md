...
The accepted formatting patterns are described in the [Sheets API date and number formatting guide](https://developers.google.com/sheets/api/guides/formats).
