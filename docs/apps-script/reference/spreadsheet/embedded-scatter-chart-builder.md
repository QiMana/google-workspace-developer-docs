---
source: https://developers.google.com/apps-script/reference/spreadsheet/embedded-scatter-chart-builder
root: apps-script
fetched_at: 2026-04-23T15:21:35.451Z
---
...
- EmbeddedScatterChartBuilder is a builder specifically for scatter charts.
- It provides methods to add and manage data ranges for the chart.
- The builder allows setting various visual options like background color, legend position, and axis styles.
- You can change the chart type to other chart types and obtain the corresponding builder.
- The build() method finalizes the chart construction but requires sheet methods to insert or update.
