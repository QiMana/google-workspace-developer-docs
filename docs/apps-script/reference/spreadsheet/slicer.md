---
source: https://developers.google.com/apps-script/reference/spreadsheet/slicer
root: apps-script
fetched_at: 2026-04-23T15:22:02.892Z
---
...
`Color|null` — The background color of this slicer. Returns `null` if no color is set.
...
`Integer|null` — The column position of this slicer.
...
`FilterCriteria|null` — The filter criteria of this slicer.
...
`String|null` — The background color of this slicer. Returns `null` if no color is set.
