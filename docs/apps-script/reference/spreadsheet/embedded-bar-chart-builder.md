---
source: https://developers.google.com/apps-script/reference/spreadsheet/embedded-bar-chart-builder
root: apps-script
fetched_at: 2026-04-23T15:21:36.054Z
---
...
- EmbeddedBarChartBuilder is a builder class for creating bar charts within Google Sheets.
- It provides methods to configure chart properties such as adding or removing data ranges, setting chart type, adjusting axis styles, and setting title and legend properties.
- The `build()` method finalizes the chart configuration, but the chart must be inserted or updated on a sheet separately.
- The builder allows for chaining multiple configuration methods together for ease of use.
