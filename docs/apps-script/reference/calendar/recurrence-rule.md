---
source: https://developers.google.com/apps-script/reference/calendar/recurrence-rule
root: apps-script
fetched_at: 2026-04-23T15:18:57.503Z
---
...
- RecurrenceRule represents a recurrence rule for an event series and can be chained with other rule creation methods.
- Modifiers like `times()` and `interval()` apply to the most recently added rule.
- Recurrence rules can be added on a daily, weekly, monthly, or yearly basis, with options for both inclusion and exclusion.
- You can configure rules to apply only at specific intervals or on specific days, weeks, or months using various `onlyOn` and `onlyIn` methods.
- Recurrence rules can be configured to end after a certain number of occurrences using `times()` or on a specific date using `until()`.
...
| Name | Type | Description |
| --- | --- | --- |
| `interval` | `Integer` | the interval in the rule's time unit |
...
| Name | Type | Description |
| --- | --- | --- |
| `days` | `Integer[]` | the days of the month |
...
| Name | Type | Description |
| --- | --- | --- |
| `days` | `Weekday[]` | the days of the week |
...
| Name | Type | Description |
| --- | --- | --- |
| `day` | `Integer` | the day of the year |
...
| Name | Type | Description |
| --- | --- | --- |
| `days` | `Integer[]` | the days of the year |
...
| Name | Type | Description |
| --- | --- | --- |
| `times` | `Integer` | the number of times to recur |
...
| Name | Type | Description |
| --- | --- | --- |
| `day` | `Weekday` | the day on which the week starts |
