---
source: https://developers.google.com/apps-script/reference/drive/user
root: apps-script
fetched_at: 2026-04-23T15:20:04.966Z
---
...
`String|null` — the user's name, or `null` if the name is not available
...
`String|null` — the URL for the user's photo, or `null` if the photo is not available
