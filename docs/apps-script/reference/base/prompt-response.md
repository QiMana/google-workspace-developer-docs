---
source: https://developers.google.com/apps-script/reference/base/prompt-response
root: apps-script
fetched_at: 2026-04-23T15:18:48.286Z
---
...
- The `getResponseText()` method retrieves the text entered by the user in the dialog's input field.
- The `getSelectedButton()` method identifies which button the user clicked to close the dialog, including the close button in the title bar.
