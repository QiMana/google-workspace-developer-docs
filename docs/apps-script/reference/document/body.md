---
source: https://developers.google.com/apps-script/reference/document/body
root: apps-script
fetched_at: 2026-04-23T15:19:30.890Z
---
...
- Scripts using the documented methods require authorization with either the `https://www.googleapis.com/auth/documents.currentonly` or `https://www.googleapis.com/auth/documents` scopes.
- Methods are available to insert and remove elements like tables within the document body.
- Text content can be manipulated by replacing text patterns using regular expressions.
- Various attributes, including formatting and margins, can be set for elements and headings within the document body.
- Page dimensions such as height and width can be adjusted.

The content of a tab in a Google Docs document. The `Body` may contain `ListItem`, `Paragraph`, `Table`, and `TableOfContents` elements. For more information on document structure, see the [guide to extending Google Docs](https://developers.google.com/apps-script/guides/docs#structure_of_a_document).
...
| Name | Type | Description |
| --- | --- | --- |
| `paragraphHeading` | `ParagraphHeading` | The heading whose attributes should be retrieved. |
...
`Number|null` — The bottom margin, in points.
...
`Number|null` — The left margin, in points.
...
`Number|null` — The right margin, in points.
...
`Number|null` — The top margin, in points.
...
`Number|null` — The page height, in points.
...
`Number|null` — The page width, in points.
...
| --- | --- | --- |
| `childIndex` | `Integer` | The index at which to insert the element. |
| `pageBreak` | `PageBreak` | The page break to insert. |
...
| Name | Type | Description |
| --- | --- | --- |
| `paragraphHeading` | `ParagraphHeading` | The heading whose attributes should be set. |
| `attributes` | `Object` | A map of attributes and the values to set them to. |
...
| Name | Type | Description |
| --- | --- | --- |
| `marginBottom` | `Number` | The bottom margin, in points. |
...
| Name | Type | Description |
| --- | --- | --- |
| `marginLeft` | `Number` | The left margin, in points. |
...
| Name | Type | Description |
| --- | --- | --- |
| `marginTop` | `Number` | The top margin, in points. |
...
| Name | Type | Description |
| --- | --- | --- |
| `pageHeight` | `Number` | The page height, in points. |
...
| Name | Type | Description |
| --- | --- | --- |
| `pageWidth` | `Number` | The page width, in points. |
