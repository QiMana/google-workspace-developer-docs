---
source: https://developers.google.com/apps-script/reference/document/equation-function
root: apps-script
fetched_at: 2026-04-23T15:19:35.796Z
---
...
An element representing a function in a mathematical . An `EquationFunction` may contain `EquationFunction`, `EquationFunctionArgumentSeparator`, `EquationSymbol`, and `Text` elements. For more information on document structure, see the [guide to extending Google Docs](../../guides/docs.md#structure_of_a_document).
...
`EquationFunction|null` — The merged element.
...
`EquationFunction|null` — The removed element.
