---
source: https://developers.google.com/apps-script/reference/document/equation
root: apps-script
fetched_at: 2026-04-23T15:19:36.567Z
---
...
- An Equation element represents a mathematical expression and can contain EquationFunction, EquationSymbol, and Text elements.
- Equation elements have methods to manipulate their content, such as clearing, copying, and editing as text.
- You can search within an Equation element for specific element types or text patterns using provided methods.
- Methods are available to get information about an Equation element's structure, including its children and parent.
- You can set attributes, link URLs, and text alignment for an Equation element.

An element representing a mathematical expression. An `Equation` may contain `EquationFunction`, `EquationSymbol`, and `Text` elements. For more information on document structure, see the [guide to extending Google Docs](https://developers.google.com/apps-script/guides/docs#structure_of_a_document).
...
`Equation|null` — The merged element.
...
`Equation|null` — The removed element.
