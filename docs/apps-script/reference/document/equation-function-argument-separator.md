---
source: https://developers.google.com/apps-script/reference/document/equation-function-argument-separator
root: apps-script
fetched_at: 2026-04-23T15:19:37.503Z
---
...
- The EquationFunctionArgumentSeparator represents a function separator in a mathematical Equation element and cannot contain other elements.
- You can copy the EquationFunctionArgumentSeparator element, retrieving a detached, deep copy of the current element.
- You can retrieve the element's attributes, next sibling, parent, previous sibling, and type.
- You can check if the element is at the end of the Document.
- You can merge the element with a preceding sibling of the same type or remove it from its parent.
- You can set the element's attributes.

An element representing a function separator in a mathematical . An `EquationFunctionArgumentSeparator` cannot contain any other element. For more information on document structure, see the [guide to extending Google Docs](https://developers.google.com/apps-script/guides/docs#structure_of_a_document).
...
`EquationFunctionArgumentSeparator|null` — The merged element.
...
`EquationFunctionArgumentSeparator|null` — The removed element.
