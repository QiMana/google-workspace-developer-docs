---
source: https://developers.google.com/apps-script/reference/document/person
root: apps-script
fetched_at: 2026-04-23T15:19:47.491Z
---
...
`String|null` — The display name of the person link, or `null` if the element displays the email address instead.
...
`Person|null` — The merged element.
...
`Person|null` — The removed element.
