---
source: https://developers.google.com/apps-script/reference/document/inline-drawing
root: apps-script
fetched_at: 2026-04-23T15:19:40.832Z
---
...
`InlineDrawing|null` — The merged element.
...
`InlineDrawing|null` — The removed element.
