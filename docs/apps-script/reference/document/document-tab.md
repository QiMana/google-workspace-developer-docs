...
| `range` | `Range` | The range of elements to associate with the name; the range can be a [search result](./body.md#findText(String)) or manually constructed with `newRange()`. |
