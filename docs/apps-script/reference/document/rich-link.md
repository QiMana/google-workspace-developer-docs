...
Returns the [MIME type](https://developers.google.com/drive/api/v3/mime-types) of the link, which is available when the item is a link to a Drive file and `null` otherwise.
