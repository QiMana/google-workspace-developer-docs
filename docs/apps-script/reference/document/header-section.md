---
source: https://developers.google.com/apps-script/reference/document/header-section
root: apps-script
fetched_at: 2026-04-23T15:19:42.560Z
---
...
- HeaderSection represents a header section in a Document and typically contains at most one.
- HeaderSection can contain ListItem, Paragraph, and Table elements.
- Methods are available to append and insert various elements like HorizontalRule, Image, ListItem, Paragraph, and Table into the HeaderSection.
...
`HeaderSection|null` — The removed element.
