---
source: https://developers.google.com/apps-script/api/quickstart/js
root: apps-script
fetched_at: 2026-04-23T15:18:09.340Z
---
...
- This quickstart demonstrates how to create a JavaScript web application that interacts with the Google Apps Script API using a simplified authentication method suitable for testing.
- To set up your environment, you need to enable the Google Apps Script API in your Google Cloud project and configure the OAuth consent screen.
- Authorizing credentials for a web application involves creating an OAuth 2.0 Client ID and, optionally, an API key in the Google Cloud console.
- The sample code provided includes HTML and JavaScript to handle authorization, sign-in/out, and the creation of a simple Apps Script project.
- To run the sample, you need to set up an HTTP server, navigate to the local host address, and authorize the application's access to your Google Account.
