...
root: apps-script
fetched_at: 2026-04-23T15:18:14.333Z
---
...
This error occurs when you have not authorized the desktop application credentials. To learn how to create credentials for a desktop application, go to [Create credentials](../../workspace/guides/create-credentials.md#desktop-app).
