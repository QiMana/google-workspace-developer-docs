...
There are three main phases in the lifecycle of a [Presentation](../../reference/slides/presentation.md) object: open, edit, and save.

## Open a presentation

When using the Slides Service, the first step is to load a presentation. Methods like [SlidesApp.openById()](../../reference/slides/slides-app.md#openbyidid) and [SlidesApp.getActivePresentation()](../../reference/slides/slides-app.md#getactivepresentation) load an existing Slides presentation, while [SlidesApp.create()](../../reference/slides/slides-app.md#createname) creates a new presentation. These methods return a [Presentation](../../reference/slides/presentation.md) object that represents the loaded presentation.
